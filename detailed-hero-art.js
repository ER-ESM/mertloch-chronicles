...
export function drawDetailedHero(c,id,x,y,p={},magnify=1){
 ...
 if(!p.legacyArt&&drawPaperdoll(c,p.paperdollId||id,x,y,p,magnify))return true;// paperdollId: Söldner zeichnen ihre Figur (npc:<id>), Klassenaussehen bleibt am look
