...
import {tintedFrame,drawFaceItem,drawHairStyle} from './hero-tint.js';
...
export function drawRedesignPerson(c,id,x,y,p={},magnify=1,drawClothing){
 ...
 if(p.tint&&!down&&!items.some(i=>i.slot==='head')){drawHairStyle(c,f,id,p.tint);drawFaceItem(c,f,id,p.tint);} // ein Helm verdeckt Brille und Stirnband
