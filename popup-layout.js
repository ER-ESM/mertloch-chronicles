...
export function touchPopupBounds({width,height,safe={top:0,right:0,bottom:0,left:0},controls=[],preferredWidth=440,fill=false}){
 const landscape=width>height,gap=8;
 let left=safe.left+12,right=width-safe.right-12,top=safe.top+(landscape?12:104),bottom=height-safe.bottom-(landscape?32:24);
