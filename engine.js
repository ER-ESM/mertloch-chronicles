...
import {DUNGEON_CASTS,ENEMY_AUTOS} from './content/index.js';
...
export class Game{
  ...
  die(by,skill='',ground=false,amount=0){if(this.dead)return;this.dead=true;finishMeterCombat(this);stopAuto(this,false);this.casting=null;this.keys.clear();this.moveTo=null;this.path=[];this.routeGoal=null;/* E-72 R4: ein angehaltener Laufweg lief nach dem Aufwachen weiter – zurück ins Rudel */this.autopilot=null;this.autopilotResume=null;this.memoryEvent({kind:'firstDeath'});/* Ursache für den Todesbildschirm (death-screen.js, Runde 5a) */this.emit('death',{by,skill,ground,amount});}
