...
export class Game{
  constructor(world,saved={},options={}){
    ...
    this.settings={autoLoot:saved.settings?.autoLoot!==false,prerender:saved.settings?.prerender===true,sct:saved.settings?.sct!==false,light:saved.settings?.light!==false,fx:saved.settings?.fx!==false,fps:saved.settings?.fps===true,fullRes:saved.settings?.fullRes===true,autoRes:saved.settings?.autoRes!==false,namesFriendly:saved.settings?.namesFriendly!==false,namesEnemy:saved.settings?.namesEnemy!==false,namesPlayers:saved.settings?.namesPlayers!==false,sctIn:saved.settings?.sctIn!==false,sctNotes:saved.settings?.sctNotes!==false,sctCompanions:saved.settings?.sctCompanions!==false};
