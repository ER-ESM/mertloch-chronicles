...
export class Game {
  ...
  action(id,point=null){
    ...
    if(p.energy<cost){this.toast('Nicht genug Randale. Dein Grundangriff [1] lädt sie wieder auf.');return false;}
    let e=this.target;
