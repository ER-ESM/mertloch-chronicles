...
export function paintUiControls(root=document){root.querySelectorAll('[data-ui-icon]').forEach(c=>{paintUiIcon(c,c.dataset.uiIcon);/* Clanbuch-Reiter: Motiv füllt das Symbol */if(c.closest?.('.book-tabs'))fitMotif(c,.96);});}
