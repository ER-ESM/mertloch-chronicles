...
export const PLAY_HELP={
 desktop:[
  ...
  ['Wörter im Dorf',['Ressource: jede Klasse zahlt anders – Dieter mit Randale, Anni mit Likes, Kevin mit Leergut, Schorsch mit Glut, Käthe mit Karten und Augen.','Kniffe: deine Fähigkeiten, gelernt im Skillbuch, gelegt auf die Leiste, abgefeuert mit 1–0.','Klamotten: Kutte, Schürze, Werkzeuggürtel, Grillschürze oder Strickjacke vom Kleiderhaufen – sie entscheiden, wie du kämpfst, nicht wie du riechst.','Pfandmarken: das Geld von Mertloch – Leergut, Beute und Kalle rechnen alle in derselben Währung.']]
 ],
 touch:[
  ...
  ['Wörter im Dorf',['Ressource: jede Klasse zahlt anders – Dieter mit Randale, Anni mit Likes, Kevin mit Leergut, Schorsch mit Glut, Käthe mit Karten und Augen.','Kniffe: deine Fähigkeiten, gelernt im Skillbuch, gelegt auf die Leiste, abgefeuert über deine Kniffbuttons.','Klamotten: Kutte, Schürze, Werkzeuggürtel, Grillschürze oder Strickjacke vom Kleiderhaufen – sie entscheiden, wie du kämpfst, nicht wie du riechst.','Pfandmarken: das Geld von Mertloch – Leergut, Beute und Kalle rechnen alle in derselben Währung.']]
 ],
 desktopKeys:[
