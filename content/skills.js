...
export const KITS={
 ...
 baerbel:[
  {name:'Pinsel-Piekser',cd:.95,range:155,damage:48,gain:10,icon:'speaker',text:'200 % Autoschaden + 14 Fernkampfschaden, +1 Glanz und 10 Randale. Triff nach 0,85–1,5 s erneut für einen zusätzlichen Glanzpunkt. Deine Standardtaste: im Takt treffen statt hämmern. Drück ihn, wenn nichts anderes bereit ist.'},
  {name:'Fleckentest, Schätzchen!',range:190,dot:10,text:'10 s Markierung, 10 Schaden pro Sekunde. Verstärkt deinen nächsten Turbo-Einschlag um 60 %. Drück ihn auf jeden neuen Gegner, bevor die Turbostufe kommt.'},
  {name:'Thermomix-Turbostufe',range:175,base:40,perPoint:48,splash:95,text:'14 Schaden + (150 % + 280 % pro Glanz) Autoschaden, markiert +60 %. Gegner im Umkreis von 12 m erhalten 55 % des Einschlags – auch neutrale! Verbraucht alle Glanzpunkte. Zünde sie bei 3 Glanz auf ein markiertes Ziel mitten in der Gruppe.'},
  {name:'Kommentarspalte zu!',range:190,cd:10,text:'35 Schaden. Unterbricht gelbe Zauber und macht das Ziel 4 s verwundbar. „Deine Meinung hat Sendepause.“ Drück sie, sobald ein gelber Zauberbalken läuft.'},
  {name:'Hygiene-Handschuh',window:.9,reflect:55,text:'0,9 s Parierfenster. Reflektiert 55 Schaden, gibt einen Glanzpunkt und 20 Randale. Keine Heilung. Drück ihn kurz vor dem angekündigten Treffer.'},
  {name:'Raus aus meinem Reel',cd:6,steps:24,text:'Ein längerer Ausweichsprung mit 0,4 s Schutz. „Du stehst im Bild, verdammte Axt!“ Drück ihn aus roten Flächen heraus und um Abstand zu halten.'},
...
export const BUFF_SKILLS={
 ...
 dieter:{name:'Dosenmut',reduction:.25,text:'10 Sekunden weniger Schaden. Der Türsteher baut zusätzlich Deckung auf. Zünde ihn, bevor du eine Gruppe aufmischst.'},
 baerbel:{name:'Aperol-Nachsorge',hot:12,text:'10 Sekunden Hauspflege: heilt jede Sekunde. Orange im Glas, Grün im Lebensbalken. Annis fragwürdiges Wellnessprogramm. Zünde sie, bevor es eng wird, nicht wenn du schon fast liegst.'},
...
export const THROW_SKILL={id:'throw',key:'3',cd:6,cost:18,range:235,damage:75,icon:'bottle',color:'#dbc083',bg:'#5b6036',
 ...
 text:' trifft ein einzelnes Ziel. 300 % Autoschaden + 24 Schaden, 18 Randale. Ideal, um einen Gegner aus der Gruppe zu ziehen. Wirf ihn, wenn das Ziel noch außer Reichweite steht.'};
export const GROUND_SKILL={id:'ground',key:'7',cd:12,cost:35,ground:true,range:210,radius:70,damage:125,delay:1.1,icon:'burst',color:'#e6b769',bg:'#79633e',
 ...
 text:'Mit der Maus einen freien Bodenpunkt wählen. Nach 1,1 s: 125 Grundschaden im Umkreis von 9 m an bis zu 5 Zielen – auch neutralen. Rechtsklick oder Esc bricht das Zielen ab. Wirf ihn dorthin, wo die Gruppe gleich steht, nicht dorthin, wo sie gerade steht.'};
/** Aktive Talentfähigkeiten (Schlüssel = grants in talents.js). */
export const TALENT_SKILLS={
 barricade:{name:'Absperrband',ground:true,range:170,radius:85,duration:8,cd:24,cost:25,text:'Platziere eine Zone: darin 30 % weniger Schaden. Bleib hinter deiner Absperrung, statt blind hinterherzulaufen. Stell sie, bevor die Gruppe bei dir ist.'},
 slam:{name:'Tresensprung',ground:true,range:145,radius:60,damage:95,cd:16,cost:20,text:'Springe zum freien Zielpunkt, triff bis zu 5 Gegner und erhalte 1 Pegel. Hindernisse kannst du nicht überspringen. Spring hin, wenn zwei oder mehr Gegner beieinanderstehen.'},
 keg:{name:'Katerfass',ground:true,range:160,radius:80,duration:10,cd:25,cost:25,text:'Platziere ein heilendes Fass: 24 Leben pro Sekunde, solange du darin stehst. Gegner in der Pfütze werden langsamer. Stell es auf, bevor die Gruppe dich erreicht.'},
 sanctuary:{name:'Thermomix-Tafel',ground:true,range:190,radius:85,duration:10,cd:24,cost:25,text:'Heilzone für 28 Leben pro Sekunde. Du musst darin stehen bleiben; Bewegung und Heilung sinnvoll abwägen. Stell sie, wenn du länger an einem Fleck kämpfst.'},
 infusion:{name:'Provisionskur',duration:8,cd:24,cost:15,text:'8 Sekunden lang heilen dich 35 % deines verursachten Schadens zusätzlich. Dein Schmerz, meine Provision. Schön sauber abrechnen. Zünde sie, bevor du die Gruppe angehst, nicht danach.'},
 ...
 magnet:{name:'Magnetpanzer',radius:120,cd:22,cost:25,text:'Gibt 140 Deckung, zieht bis zu 5 nahe Gegner an und hält sie kurz fest. Das zieht auch bislang neutrale Ziele in den Kampf. Zünde ihn, wenn Fernkämpfer dich einzeln beharken.'},
 snare:{name:'Pfandseil',ground:true,range:220,radius:48,duration:14,cd:16,cost:20,text:'Legt eine Falle aus. Der erste Eindringling löst 75 Schaden und 3 Sekunden Festhalten aus. Du kannst währenddessen weiterkämpfen. Leg sie auf den Weg, bevor du den nächsten Gegner ziehst.'}
};
...
const KIT_INFO={
 ...
 'dieter/heal':{effect:'Stellt sofort Leben her, ohne Randale zu kosten – dafür die längste Abklingzeit aller Kniffe.',why:'Erst unter der Hälfte Leben drücken: darüber verfällt der Überschuss, und die nächste Gelegenheit kommt erst 22 Sekunden später.',links:['proc:gut-gekuehlt','proc:zapfhahn-auf'],terms:['heilung','ueberheilung','abklingzeit']},
 ...
 'baerbel/heal':{effect:'Heilt dich nach kurzer Wirkzeit; Bastelgrips, Wumms und Handschrift verstärken die Menge.',why:'Anni heilt schon ab Stufe 2 und drückt diesen Knopf ständig – fast jeder ihrer Talentbäume hängt einen Zusatzeffekt an genau diesen Auslöser.',links:['proc:kurzer-hausbesuch','proc:frisch-gewischt','talent:baerbel-care-0'],terms:['heilung','wit','masteryRating','hauspflege','wirkzeit','proc']},
...
THROW_SKILL.info={
 ...
 kevin:{effect:'Kevins Fernstart: derselbe Einzelwurf, aber schon auf Stufe 2 gelernt.',why:'Ohne ihn hätte Kevin bis Stufe 6 keine Antwort auf Gegner, die selbst aus der Distanz auf ihn halten.',links:['passive:kevin','proc:fangschuss','proc:nachladen-im-rennen'],terms:['wurf','reichweite','druck']}
};
GROUND_SKILL.info={
