...
export const DROP_TABLES={
 ...
 warden:{material:'kabel',materialChance:.32,gearChance:.2,unique:'ruhepfeife',uniqueChance:.012,coinsChance:.7,slots:['weapon','body','feet']},
 horst:{material:'hausordnung',materialChance:.5,gearChance:.85,unique:'horststempel',uniqueChance:.12,coinsChance:.9,slots:['weapon','body','charm']},
 // --- neue Familien ---
 ...
 scrounger:{material:'kronkorken',materialChance:.35,gearChance:.14,unique:'schnorrerbecher',uniqueChance:.01,coinsChance:.55,slots:['weapon','body','feet']},
 inspector:{material:'flugblatt',materialChance:.45,gearChance:.22,unique:'praktikantenausweis',uniqueChance:.012,coinsChance:.75,slots:['weapon','body','feet','charm']},
 elite:{material:'borste',materialChance:.8,gearChance:.5,unique:'keilerzahn',uniqueChance:.06,coinsChance:0,slots:['weapon','charm']},
 gisela:{material:'hopfen',materialChance:.5,gearChance:.85,unique:'giesskanne',uniqueChance:.14,coinsChance:.9,slots:['weapon','body','feet','charm']},
 automat:{material:'dosenblech',materialChance:.5,gearChance:.85,unique:'automatenarm',uniqueChance:.16,coinsChance:.9,slots:['weapon','body','feet','charm']}
};
/** Verpflegung, die menschliche Gegner und Bosse zusätzlich fallen lassen können. */
export const FOOD_DROPS={warden:'brezel',scrounger:'kaltgetraenk',inspector:'brezel',horst:'brezel',gisela:'currywurst',automat:'kaltgetraenk'};
