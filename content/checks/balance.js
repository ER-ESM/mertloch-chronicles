...
export function check(bad){
 ...
 const known={enemies:{...ARCHETYPES,...ELITES,...CAMP_ENEMIES,...BOSSES},items:ITEM_CATALOG,skills:KITS,mechanics:SPEC_MECHANICS,specs:SPEC_MECHANICS};const DEEP=v=>typeof v==='number'||(v&&typeof v==='object'&&Object.values(v).every(DEEP));
