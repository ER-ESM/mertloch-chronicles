...
export const SPEC_MECHANICS={
 'dieter-wall':{kind:'guard',name:'Hausrecht',
  ...
  kit:{burst:{name:'Rausschmiss',text:'Verbraucht Pegel und bis zu 80 Deckung: Stoß mit der Tresenkante, die Deckung trifft alle Gegner ringsum.',use:'Zünde ihn, wenn die Deckung fast voll ist – bei 95 % Deckung gilt 8 s Hausverbot und Paraden werfen doppelt zurück.'}},
 ...
 'dieter-brawl':{kind:'stack',name:'Deckelstriche',
  ...
  kit:{burst:{name:'Abriss',text:'Verbraucht Pegel und alle Deckelstriche: je Strich 12 % mehr Schaden.',use:'Zünde ihn, bevor der Pegel abläuft – läuft er ohne Abriss aus, kommt 3 s Kater.'},
   strike:{name:'Kronkorken-Kelle',text:'Eine schwere Kelle im Nahkampf: baut Pegel und einen Deckelstrich auf und frischt die Deckel-Uhr auf.',use:'Drück sie, sobald sie bereit ist; jeder kassierte Treffer gibt ebenfalls einen Strich.'}},
 ...
 'dieter-brew':{kind:'fields',name:'Fässer',
  ...
  kit:{ground:{name:'Anstich',text:'Stellt ein Fass auf den gewählten Boden (höchstens zwei). Im Umkreis wirkt die Sorte: Weizen heilt, Pils gibt Tempo, Bock verletzt Gegner.',use:'Stell es dort, wo du kämpfen willst, bevor die Gegner ankommen.'},
   burst:{name:'Fassanstich',text:'Verbraucht Pegel für einen schweren Treffer und sticht alle stehenden Fässer an: Bock explodiert, Weizen heilt voll, Pils gibt 5 s Laufzauber.',use:'Zünde ihn, wenn zwei Fässer stehen und die Gegner darin sind.'}},
 ...
 'baerbel-care':{kind:'supply',name:'Vorrat',
  ...
  kit:{ground:{name:'Nest',text:'Setzt Gans Gisela auf ein Nest: heilt 12 s lang alle im Umkreis; beim Aufstehen schnattert sie Gegner ringsum kurz nieder.',use:'Stell es unter dich, wenn du länger an einem Fleck heilen musst.'},
   burst:{name:'Großreinemachen',text:'Verbraucht Glanz für einen starken Einschlag. Bei 5 Vorrat beginnt 10 s Großreinemachen: jede Heilung trifft das Ziel zusätzlich als Schaden.',use:'Zünde sie, sobald die fünf Gläser voll sind.'},
 ...
 'baerbel-feedback':{kind:'dot',name:'Schimmel',
  ...
  kit:{mark:{name:'Schimmel',text:'Markiert das Ziel mit Schimmel, der regelmäßig Schaden macht. Ein Pinsel-Piekser auf ein verschimmeltes Ziel überträgt den Schimmel auf einen Nachbarn, ein Kill auf zwei.',use:'Drück ihn zuerst und verteile ihn dann mit Pieksern.'},
   burst:{name:'Durchputzen',text:'Verbraucht Glanz für einen starken Einschlag und lässt jeden Schimmel im Umkreis platzen: fünf Ticks Schaden auf einmal, die Markierungen sind danach weg.',use:'Zünde sie, wenn drei oder mehr Gegner verschimmelt sind.'},
 ...
 'baerbel-stage':{kind:'state',name:'Putzwut',
  ...
  prost:{energy:30},
  kit:{burst:{name:'Auswringen',text:'Verbraucht Glanz für einen starken Einschlag. Bei 100 Randale beginnt 10 s Putzwut: alle Kniffe kostenlos, 25 % härter, im Laufen wirkbar. In der Putzwut beendet Auswringen den Zustand mit Bonusschaden aus der Rest-Randale.',use:'Zünde es kurz vor Ablauf der Putzwut.'},
   buff:{name:'Ringlicht',text:'Kurz mehr Schaden.',use:'Drück es, sobald die Randale über 80 liegt – die Putzwut kommt dann sicher.'}},
 ...
 'kevin-fuse':{kind:'chain',name:'Kurzschluss',
  ...
  kit:{mark:{name:'Lunte',text:'Klebt eine Lunte ans Ziel: regelmäßig Schaden, und wenn sie abbrennt oder gezündet wird, explodiert sie im Umkreis.',use:'Drück sie zuerst auf jeden Gegner, den du sprengen willst.'},
   burst:{name:'Kurzschluss',text:'Verbraucht Druck für einen Blitz, der auf bis zu drei Nachbarn überspringt (je Sprung 30 % weniger) und Lunten sofort zündet. Drei Zündungen in 10 s lösen eine Kettenreaktion aus: Kurzschluss sofort bereit, fünf Sprünge.',use:'Zünde ihn, wenn mehrere Gegner Lunten tragen.'}},
 ...
 'kevin-iron':{kind:'turret',name:'Dosen-Robbi',
  ...
  kit:{ground:{name:'Aufstellen',text:'Stellt Dosen-Robbi auf den gewählten Boden: 15 s lang feuert er jede Sekunde auf den nächsten Gegner und bremst alle im Umkreis.',use:'Stell ihn zwischen dich und die Gruppe, bevor du Druck aufbaust.'},
   burst:{name:'Überlast',text:'Steht Robbi, überlastet er dabei und explodiert im Umkreis – Robbi ist danach weg. Verbraucht Druck für einen schweren Treffer.',use:'Zünde sie, wenn die Gegner um Robbi stehen.'}},
 ...
 'kevin-hunt':{kind:'gamble',name:'Bastler-Glück',
  ...
  kit:{strike:{name:'Pfandgeschoss',text:'Ein Fernkampftreffer baut Druck und Randale auf – bei Kevin mit Bastler-Glück: 20 % Fehlzündung (schwächer), 20 % Überzündung (fast doppelt, trifft Nachbarn). Nach drei Fehlzündungen ist die nächste garantiert eine Überzündung.',use:'Drück ihn, wenn nichts anderes bereit ist.'},
