...
export const NEW_SPEC_MECHANICS={
 'schorsch-chef':{kind:'resource',name:'Grillbuffet',output:{damage:0.8,healing:1.15},
  ...
  paths:[{name:'Wurstbude',bonus4:{wurstHeal:.05},bonus7:{garWindow:.1}},{name:'Beilagen',bonus4:{cookSpeed:.1},bonus7:{rostSlots:1}},{name:'Stammkundschaft',bonus4:{ventHeal:.04},bonus7:{serveCleave:1}}]},
 'schorsch-flamme':{kind:'resource',name:'Flambieren',output:{damage:1},
  ...
  paths:[{name:'Stichflamme',bonus4:{overheatDamage:.15},bonus7:{overheatLock:-1}},{name:'Schwenkbraten',bonus4:{bratenDamage:.1},bonus7:{planBraten:1}},{name:'Spiritus',bonus4:{emberDot:.3},bonus7:{glutStrike:4}}]},
 ...
 'kaethe-grand':{kind:'resource',name:'Grand',output:{damage:1},
  ...
  paths:[{name:'Grand',bonus4:{bubePower:.15},bonus7:{abrechnenPower:.15}},{name:'Schneider',bonus4:{augenGain:1},bonus7:{augenWin:-6}},{name:'Null ouvert',bonus4:{luschenPower:.1},bonus7:{luschenGcd:1}}]},
