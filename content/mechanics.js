...
export const SPEC_MECHANICS={
 ...
 'baerbel-stage':{kind:'state',name:'Putzwut',output:{damage:0.89},
  ...
  prost:{energy:30},
  kit:{burst:{name:'Auswringen',text:'Ein starker Einschlag. Bei 100 Randale beginnt 10 s Putzwut: alle Kniffe kostenlos, 25 % härter, im Laufen wirkbar. In der Putzwut beendet Auswringen den Zustand mit Bonusschaden aus der Rest-Randale.',use:'Zünde es kurz vor Ablauf der Putzwut.'},
 ...
 'kevin-hunt':{kind:'gamble',name:'Bastler-Glück',output:{damage:1.25},
  ...
  kit:{strike:{name:'Pfandgeschoss',text:'Ein Fernkampftreffer gibt Randale – bei Kevin mit Bastler-Glück: 20 % Fehlzündung (schwächer), 20 % Überzündung (fast doppelt, trifft Nachbarn). Nach drei Fehlzündungen ist die nächste garantiert eine Überzündung.',use:'Drück ihn, wenn nichts anderes bereit ist.'},
...
export const NEW_SPEC_MECHANICS={
 'schorsch-chef':{kind:'resource',name:'Grillbuffet',output:{damage:0.8,healing:1.15},
  ...
  kit:{ground:{name:'Grillbuffet',text:'Schwingt den Schwenkgrill auf einen freien Bodenpunkt und baut dort ein Buffet auf, das zehn Sekunden lang alle im Kreis heilt.',use:'Stell es dorthin, wo ihr gleich kämpft.'},
   burst:{name:'Servieren',text:'Serviert das garste Stück vom Rost. Bratwurst heilt 50 % stärker und reicht für einen zweiten Verbündeten; Braten, Mais und Käse wirken wie gewohnt.',use:'Drück es, sobald eine Wurst golden schimmert.'}},
 ...
 'schorsch-rauch':{kind:'resource',name:'Räucherware',output:{damage:0.82},
  ...
  paths:[{name:'Buchenrauch',bonus4:{smokeTaunt:1},bonus7:{ventSteam:.3}},{name:'Halloumi',bonus4:{kaeseShield:.15},bonus7:{planKaese:1}},{name:'Glutnest',bonus4:{glutParry:6},bonus7:{burntGrace:.15}}]},
 'kaethe-grand':{kind:'resource',name:'Grand',output:{damage:1},
  ...
  paths:[{name:'Grand',bonus4:{bubePower:.15},bonus7:{abrechnenPower:.15}},{name:'Schneider',bonus4:{augenGain:1},bonus7:{augenWin:-6}},{name:'Null ouvert',bonus4:{luschenPower:.2},bonus7:{luschenGcd:1}}]},
 'kaethe-herz':{kind:'resource',name:'Legekreis',output:{damage:0.75,healing:1.15},
  ...
  resVariant:{},
  paths:[{name:'Herzdame',bonus4:{herzPower:.15},bonus7:{herzChain:1}},{name:'Pik-Schutz',bonus4:{pikPower:.15},bonus7:{pikReflect:.2}},{name:'Wahrsagen',bonus4:{followBonus:.1},bonus7:{redealCd:-6}}]},
