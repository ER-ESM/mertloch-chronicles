...
export const SPEC_MECHANICS={
 ...
 'baerbel-care':{kind:'supply',name:'Vorrat',
  ...
  paths:[{name:'Vorrat',bonus4:{supplyMax:2},bonus7:{cleanDuration:5}},{name:'Gisela',bonus4:{fieldDuration:6},bonus7:{nestHonk:1.5}},{name:'Reinemachen',bonus4:{cleanDamage:.5},bonus7:{overhealShield:.5}}]},
