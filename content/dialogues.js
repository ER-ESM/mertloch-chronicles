...
export const MAIN_DIALOGUE={
 ida:{
  ...
  intro:{eyebrow:'KISTEN-IDA · LOGISTIK AUF ZWEI PROMILLE',title:'Du erinnerst dich an nichts und willst etwas von mir?',
  ...
  wiederaufbau:{eyebrow:'KISTEN-IDA · BAULEITUNG',title:'Ohne Paletten gibt es keinen Tresen – und ohne Tresen keinen Clan.',
   ...
   claimed:{title:'Die Bude hat wieder eine Theke.',line:'„Hör zu, {held}: Dieter schläft neuerdings unter dem Tresen, weil er sich ihm so verbunden fühlt. Morgen bekommen wir übrigens Besuch vom Kegelclub aus Kalt. Die haben angerufen und ins Telefon gebrüllt, irgendetwas mit „unsere Bahn“ und „ihr wart das“. Das klingt für mich nach dem nächsten Kapitel.“',close:'Alles klar, Chefin.'}},
