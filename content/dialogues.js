...
export const MAIN_DIALOGUE={
 ida:{
  ...
  reward:{eyebrow:'POO-TANG LÄSST SICH NICHT ABSCHALTEN',title:'Horst hat ein Alibi. Du hast eine Hose.',
   lines:['„Horst hat um 22:01 Uhr die Polizei gerufen. Vom Festnetz. Wie jedes Jahr. Protokolliert, abgeheftet, gelocht. Der Mann war die ganze Nacht zu beschäftigt mit Anzeigen, um irgendwas zu zerlegen. Scheiße, ich hätte ihm so gern die Schuld gegeben.“',
    '„Aber: In seiner Beweismittelkiste lag deine Hose. In der Hose: ein Busticket <b>Koblenz–Mertloch</b>, Samstag, 19:40 Uhr. Und ein Handy. Nicht deins. Auf dem Sperrbildschirm steht „BASTIAN ♥ JENNY“. Also. Du warst nicht allein.“',
    'Ida drückt dir den goldenen Dosenöffner in die Hand. Auf der Rückseite steht: <b>MERTLOCH BLEIBT WACH.</b> Es ist schief graviert. Kevin war es. „Aufnahmeprüfung Teil eins bestanden. Teil zwei: Wir bauen die Bude wieder auf. Mit dir. Weil du sonst keine hast.“'],
  ...
  wiederaufbau:{eyebrow:'KISTEN-IDA · BAULEITUNG',title:'Ohne Tresen kein Clan. Ohne Paletten kein Tresen.',
   ...
   reward:{eyebrow:'DER TRESEN STEHT. SCHIEF. ABER ER STEHT.',title:'Sigi hat gewunken. Der Kasten hat zurückgewunken.',
    lines:['„Sigi kam um drei mit dem Hänger. Da war die Bude schon hin. Aber er hat einen Bus wegfahren sehen. Koblenzer Kennzeichen. Und hinten dran, auf der Stoßstange: <b>einer in Unterhose mit Bierkasten auf dem Kopf</b>. Sigi hat gewunken. Der Kasten hat zurückgewunken.“',
     '„Ich sag jetzt nichts. Dieter sagt nichts. Anni macht ein Foto. Kevin fragt, ob der Kasten voll war. Wir bauen erst mal weiter. Der Tresen steht, der Grill ist wieder rund, und Kevin hat eine Werkstatt aus einem Kühlschrank. Du kannst ab jetzt an der Bude mitbauen – Material bringst du, Vorteile kriegen wir alle.“'],
  ...
  kegelclub:{eyebrow:'KISTEN-IDA · NACHBARSCHAFTSHILFE',title:'Kalt hat angerufen. Kalt hat geschrien.',
   ...
   reward:{eyebrow:'ALLE NEUNE. UND EINER IN UNTERHOSE.',title:'Zwölf weiße Shirts. Und deine Stimme.',
    lines:['„Klaus hat sie gesehen. Zwölf Mann in gleichen weißen T-Shirts, <b>GAME OVER</b> draufgedruckt. Die haben die Kegelbahn zerlegt, als der Bus falsch abgebogen ist. Und mittendrin: einer in Unterhose, der die ganze Zeit <b>„NEUES SPIEL!“</b> geschrien hat. Klaus hat es nachgemacht. Wir haben alle dich angeguckt.“',
     '„Du hast die Stimme erkannt. Das hab ich an deinem Gesicht gesehen. Also gut: Du warst dabei. Auf welcher Seite, wissen wir noch nicht. Aber Klaus hat uns die Kabel gelassen, die Anlage läuft wieder, und Dieter hat ihm die Kugel zurückgegeben. Fast. Er hat eine andere Kugel zurückgegeben.“'],
    claim:'Neues Spiel.'},
  ...
  bus:{eyebrow:'KISTEN-IDA · ENDSTATION',title:'Der Bus steht im Feld. Der Bus singt.',
   ...
   reward:{eyebrow:'AKT 1 · FILMRISS · ENDE',title:'Du bist in den falschen Bus gestiegen. Willkommen im Clan.',
    lines:['„Timo hat dich erkannt. <b>Koblenz Hauptbahnhof, Samstag, 19:40</b>. Du bist eingestiegen, weil du dachtest, das wär der Nachtbus. Du hast Bastians Shirt gekriegt, weil er gekotzt hat. Ihr seid in Mertloch gelandet, weil der Fahrer Kalt mit Mertloch verwechselt hat. Ihr wart auf unserem Fest. Ihr habt mit uns gesoffen. Dann gab es eine Meinungsverschiedenheit über die Kiste. Dann gab es keine Bude mehr.“',
     '„Die Unbekannten waren zwölf Junggesellen, ein sturzbetrunkener Clan – und du. Dieter hat den Tresen selbst umgetreten. Er sagt, der war eh morsch. Anni hat Fotos. Kevin hat die Anlage in Sicherheit gebracht, in Sigis Hänger, ohne Sigi zu fragen. Und die Kiste …“ Ida zeigt dir Timos Handyvideo. Du. In Unterhose. Mit der Kiste im Arm. Du gibst sie einem Mann mit Pappkrone. Freiwillig. Du lachst dabei.',
     '„Bastian hat die Kiste. Als Hochzeitsgeschenk. Er heiratet Samstag in Koblenz. Und du hast sie ihm gegeben, und keiner von uns weiß, warum. Also.“ Sie schaut dich lange an. „Wer mit uns kaputt macht, baut mit uns auf. Du bist jetzt Poo-Tang. Nicht, weil wir dich mögen. Weil du uns was schuldest. Und am Samstag holen wir die Kiste.“'],
