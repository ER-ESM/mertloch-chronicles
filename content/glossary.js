...
export const GLOSSARY={
 ...
 grundangriff:{name:'Grundangriff',short:'Taste 1: der Aufbaukniff, der Punkte und Randale liefert.',
 ...
 zauberbalken:{name:'Zauberbalken',short:'Kündigt einen Gegnerangriff an. Gelb heißt: unterbrechbar.',
  long:'Ein gelber Balken ist deine Einladung, Taste 4 zu drücken – das spart den Schaden und öffnet 4 s Verwundbarkeit. Ein Balken mit Bodenmarkierung kündigt eine Fläche an; da hilft Ausweichen statt Unterbrechen.'},
 spezialisierung:{name:'Spezialisierung',short:'Einer von drei Talentbäumen je Klamotte – er entscheidet deine Rolle.',
  long:'Jeder Baum hat genau zehn Talente; in Reihe drei steht immer eine neue aktive Fähigkeit, unten das Abschlusstalent. Die Spezialisierung verändert zusätzlich Kniff-Verhalten direkt (zum Beispiel macht Schrottkoloss aus Kevins Wurf einen Nahkampfangriff).'},
 ...
 rotation:{name:'Rotation',short:'Die Reihenfolge, in der die vier Kerntasten zünden.',
  long:'Ab Stufe 4 stehen Grundangriff (1), Markierung (2), Eskalation (3) und Unterbrechen (4), dazu Ausweichen und Parade als Antworten. Der Ablauf ist überall gleich: markieren, Punkte aufbauen, bei drei Punkten eskalieren – und auf gelbe Balken und rote Flächen reagieren.'},
