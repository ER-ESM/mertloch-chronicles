...
export const GLOSSARY={
 randale:{name:'Randale',short:'Dein Kraftstoff: Kniffe kosten Randale, Treffer und Kills füllen sie nach.',
  long:`Skala 0 bis 100. Außerhalb des Kampfes fließen ${P.energyRegen} Randale je Sekunde nach, im Kampf ${MO.combatEnergyRegen}; jeder Punkt Bastelgrips gibt zusätzlich ${nice(W.energyRegenWit)} je Sekunde. Dein Grundangriff zahlt je nach Klamotten 10 bis 18 zurück, jeder Kill ${MO.energyOnKill}. Fehlt Randale, zündet der Kniff nicht und die Leiste meldet „Nicht genug Randale“.`},
 ...
 pegel:{name:'Pegel',short:'Dieters Aufbaupunkte. Kellen, Paraden und Tresensprung füllen ihn.',
 ...
 glanz:{name:'Glanz',short:'Annis Aufbaupunkte. Im Takt getroffen gibt der Pinsel-Piekser zwei statt einem.',
 ...
 druck:{name:'Druck',short:'Kevins Aufbaupunkte. Geschosse, Paraden und Unterbrechungen laden ihn.',
 ...
 eskalation:{name:'Eskalation',short:'Der Finisher auf Taste 3: verbraucht alle Aufbaupunkte für den großen Schlag.',
  long:'Schaden = fester Anteil + (150 % + 260 bis 320 % je verbrauchtem Punkt) deines Autoschadens. Gegen ein markiertes Ziel schlägt die Eskalation 60 % (Dieter, Anni) bis 80 % (Kevin) härter. Annis Turbostufe trifft zusätzlich alle im Umkreis mit 55 % des Einschlags, Kevins Rakete stößt zurück.'},
 ...
 glueckstreffer:{name:'Glückstreffer',short:'Ein kritischer Treffer – deutlich mehr Schaden und Auslöser vieler Talente.',
  long:`Grundchance ${pc(R.crit.base)}. Jeder Punkt Glückstreffer-Wertung und ${pc(R.crit.finesseWeight)} deines Taktgefühls zählen über r ÷ (r + ${R.crit.k}); Kappe ${pc(R.crit.cap)}. Beispiel: 300 Wertung ergeben ${pc(R.crit.base+rating(300,R.crit.k))}. Ein Glückstreffer macht ×${nice(P.critMultiplier)} Schaden und ist der Proc-Auslöser crit.`},
 stamina:{name:STAT_NAMES.stamina,short:'Leben. Der einzige Wert, der dich schlicht länger stehen lässt.',
 ...
 might:{name:STAT_NAMES.might,short:'Wucht: mehr Schaden, mehr Deckung, etwas Rüstung.',
  long:`Je Punkt ${pc(W.might)} Schaden, zusätzlich ${pc(W.physicalMight)} auf körperliche Kniffe, ${pc(W.shieldMight)} auf Deckung, ${pc(W.healMight)} auf Heilung. Dazu zählt Wumms mit ${pc(R.armor.mightWeight)} als Rüstungswertung.`},
 finesse:{name:STAT_NAMES.finesse,short:'Präzision: etwas Schaden, vor allem Tempo und Glückstreffer.',
  long:`Je Punkt ${pc(W.finesse)} Schaden. Taktgefühl zählt mit ${pc(R.haste.finesseWeight)} als Drehzahl und mit ${pc(R.crit.finesseWeight)} als Glückstreffer-Wertung – deshalb wirkt es doppelt, auch ohne einen einzigen Punkt Drehzahl auf der Ausrüstung.`},
 wit:{name:STAT_NAMES.wit,short:'Technik: Schaden auf Bastelkniffe, Heilung, Deckung und Randale-Nachschub.',
  long:`Je Punkt ${pc(W.wit)} Schaden, ${pc(W.technicalWit)} auf technische Kniffe, ${pc(W.healWit)} auf Heilung, ${pc(W.shieldWit)} auf Deckung und ${nice(W.energyRegenWit)} Randale je Sekunde.`},
 armorRating:{name:STAT_NAMES.armorRating,short:'Senkt eingehenden Schaden – mit abnehmendem Ertrag und Kappe.',
  long:`Minderung = r ÷ (r + ${R.armor.k} + Stufe × ${R.armor.perLevel}), Kappe ${pc(R.armor.cap)}. Wumms zählt zu ${pc(R.armor.mightWeight)} in r mit. Beispiel Stufe 10 mit 300 Wertung: ${pc(rating(300,R.armor.k+10*R.armor.perLevel))} weniger Schaden. Weil der Nenner je Stufe wächst, muss Rüstung mitwachsen, um gleich stark zu bleiben.`},
 critRating:{name:STAT_NAMES.critRating,short:'Wertung, die deine Glückstreffer-Chance erhöht.',
  long:`Chance = ${pc(R.crit.base)} + r ÷ (r + ${R.crit.k}) mit r = Glückstreffer-Wertung + ${pc(R.crit.finesseWeight)} Taktgefühl. Kappe ${pc(R.crit.cap)}. 100 Wertung ergeben ${pc(rating(100,R.crit.k))} extra, 400 Wertung ${pc(rating(400,R.crit.k))} – der Ertrag sinkt, je mehr du hast.`},
 hasteRating:{name:STAT_NAMES.hasteRating,short:'Wertung, die Tempo gibt: kürzere globale Abklingzeit und schnellere Autoangriffe.',
  long:`Tempo = r ÷ (r + ${R.haste.k}) mit r = Drehzahl + ${pc(R.haste.finesseWeight)} Taktgefühl, Kappe ${pc(R.haste.cap)}. 100 Wertung ergeben ${pc(rating(100,R.haste.k))}, 350 Wertung ${pc(rating(350,R.haste.k))}. Tempo kürzt Abklingzeiten und die globale Abklingzeit und beschleunigt den Autoangriff. Schwung-Stapel kommen obendrauf und dürfen die Kappe überschreiten.`},
 masteryRating:{name:STAT_NAMES.masteryRating,short:'Wertung, die Deckung und Heilung verstärkt.',
  long:`Handschrift = r ÷ (r + ${R.mastery.k}), ohne Kappe. Davon zählen 40 % auf jede erzeugte Deckung und jede Heilung. 400 Wertung ergeben ${pc(rating(400,R.mastery.k))} Handschrift, also ${pc(rating(400,R.mastery.k)*.4)} mehr Deckung und Heilung.`},
 ...
 heilung:{name:'Heilung',short:'Stellt Leben wieder her; Bastelgrips, Wumms und Handschrift verstärken sie.',
  long:`Geheilt wird Grundwert × (1 + ${pc(W.healWit)} je Bastelgrips + ${pc(W.healMight)} je Wumms + 40 % Handschrift). Was über dein Maximalleben hinausgeht, ist Überheilung. Jede direkte Heilung ist der Proc-Auslöser heal – darauf bauen ganze Talentbäume.`},
...
const EFFECT_INFO={
 ...
 stackDecay:{label:'Pegel-Uhr läuft länger',unit:'s'},hangoverShort:{label:'Kater halbiert',fixed:1.5,unit:'s statt 3',source:MECH},stackBonus:{label:'Mehr Abriss-Schaden je Pegelstrich',unit:'%',scale:v=>v*100},stackBurstAt:{label:'Voller Abriss so viele Striche früher',unit:''},stackSpread:{label:'Abriss macht Nachbarn angetrunken (halbe Sekunde je Pegelstrich)',fixed:1,unit:'',source:MECH},stackWave:{label:'Abriss trifft Nachbarn je Pegelstrich',fixed:20,unit:'Schaden',source:MECH},waveRadius:{label:'Größerer Rausschmiss-Radius',unit:'Welteinheiten'},
 ...
 gambleOver:{label:'Höhere Überzündungs-Chance',unit:'%',scale:v=>v*100},gamblePity:{label:'Garantierte Überzündung früher',unit:'Fehlzündungen'},gambleMisfireMult:{label:'Fehlzündung weniger schwach',unit:'%',scale:v=>v*100},jackpotDuration:{label:'Jackpot hält länger',unit:'s'},jackpotStreak:{label:'Jackpot früher',unit:'Überzündungen'},hausverbotDuration:{label:'Hausverbot hält länger',unit:'s'},mobileCast:{label:'Wirken im Laufen',fixed:1,unit:'',source:MECH},mobileMark:{label:'Markierung im Laufen',fixed:1,unit:'',source:MECH},mobileGround:{label:'Bodenkniff im Laufen',fixed:1,unit:'',source:MECH},overloadRadius:{label:'Größerer Überlast-Kreis',unit:'Welteinheiten'},chainRadius:{label:'Kurzschluss springt weiter',unit:'Welteinheiten'},overSplashShare:{label:'Überzündung trifft Nachbarn stärker',unit:'%',scale:v=>v*100},tapDamage:{label:'Mehr Bock-Explosionsschaden beim Fassanstich',unit:''},fieldHeal:{label:'Mehr Heilung je Sekunde vom Nest',unit:''},robbiHp:{label:'Robbi hält mehr Schläge aus',unit:'Leben'},
