...
export const NPCS={
 ...
 kurt:{name:'Kegelbruder Kurt',role:'„Alle Neune Kalt“ · kehrt nach Kapitel 3 die Scherben zusammen, während Klaus noch schmollt',home:'Wegestube',faction:'kalt',look:'siehe enemies.js ARCHETYPES.kegler'},
 timo:{name:'Trauzeuge Timo',role:'Trauzeuge · Chef des Junggesellenabschieds · seit Samstag wach',home:'Pfandhof',faction:'jga',look:'siehe enemies.js BOSSES.timo'},
...
export const VILLAGERS=[
 {variant:0,name:'Opa Alwin',says:['Früher war hier mehr Lärm.','Der Horst? Der war schon als Kind so.','Samstag war’s laut. Sonntag war’s still. Montag war’s kaputt.','Sigi hat 1989 meinen Hänger gefunden. Der stand in meiner Scheune.','Kegelclub aus Kalt. Ich hab gegen deren Väter verloren. Auch damals mit Blei.']},
 {variant:1,name:'Postbotin Petra',says:['Ruhe 22:01 kriegt jeden Tag neue Post. Alles Beschwerden.','Nicht wieder ein Paket voller Kronkorken.','Ich hab ’ne Hose im Briefkasten gefunden. Nicht meine.','Zwölf weiße Shirts hängen an Bertholds Zaun. Adressiert an niemanden.','Sigi kriegt Post vom Ordnungsamt. Sigi nimmt sie an. Sigi behält sie. Finderrecht.']},
 {variant:2,name:'Bäcker Bruno',says:['Brezeln sind aus. Wieder.','Wer hat den Ofen auf Bass gestellt?','Zwölf Typen im gleichen Shirt haben Samstag den Laden leergekauft. Bezahlt mit Pfandbons.','Der Bus hat Sonntag vor meinem Laden gehupt. Zwei Stunden. Melodisch.','Kalt bestellt seit 2011 nicht mehr bei mir. Ihr Verlust. Mein Umsatz.']},
 {variant:3,name:'Schülerin Sina',says:['Mein Bruder ist beim Clan. Sagt er.','Die Gans hat mein Pausenbrot.','Einer in Unterhose hat mir Samstag Nacht ’nen Bierkasten geschenkt. Leer.','Wir haben in der Schule ein GAME-OVER-Shirt versteigert. Für zwölf Euro.','Sigi hat mein Fahrrad. Er sagt, es lag. Es stand. Angeschlossen.']},
 {variant:4,name:'Bauer Berthold',says:['Die Keiler fressen mein Leergut.','Wenn Gisela kommt, geh ich in den Stall.','Da steht ein Bus in meinem Feld. Seit Sonntag. Der singt.','Der Bus hat jetzt Wäsche draußen. Weiße Shirts. Alle gleich.','Wenn Sigi den Bus holt, sag ich nichts. Und ich krieg die Hälfte.']},
 {variant:5,name:'Pfarrer Paul',says:['Auch der Herr hat am siebten Tag gefeiert.','Konrad, die Kollekte klingelt wieder metallisch.','Wer immer du bist: Der Herr vergibt. Der Clan verhandelt.','Am Sonntag lagen zwölf Männer in weißen Hemden auf meinen Stufen. Ich hab sie für Pilger gehalten.','Kalt und Mertloch beten zum selben Herrn. Und kegeln gegeneinander. Der Herr sortiert das später.']},
 {variant:6,name:'Kioskkönig Kalle',says:['Pfand geb ich nur gegen Pfand.','Der Automat nimmt meine Dosen nicht. Nie.','Ein Bus voller Vollidioten hat mir den Kiosk leergesoffen. Und einer hat den Trichter geklaut.','Die Shirts gibt’s bei mir jetzt als Putzlappen. Drei für einen Euro.','Sigi wollte meine Kühltruhe abholen. Die lief noch. Mit mir daneben.']},
 {variant:7,name:'Nachbarin Nelli',says:['Ich bin nicht bei Ruhe 22:01. Ich bin nur laut dagegen.','Gießkanne? Die hat schon meinen Rasen verklagt.','Einer in Unterhose ist über meinen Zaun. Mit Kasten auf dem Kopf. Hat sich entschuldigt. Beim Zaun.','Aus dem Bus im Feld singt seit Sonntag jemand „Auf Bastian“. Ich kenn den Text schon auswendig.','Die Kegler aus Kalt haben hier geklingelt und nach Dieter gefragt. Ich hab auf den Friedhof gezeigt. Aus Spaß.']}
];
