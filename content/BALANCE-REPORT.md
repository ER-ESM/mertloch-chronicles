...
|---|---:|---|---|---|
| Pfanddachs (1) | 1 | 3.2 s / −3 % ⚡ | 4.1 s / −3 % | 4.3 s / −8 % |
| Pfanddachs (1) | 3 | 3.1 s / −3 % | 3.8 s / −2 % | 3.5 s / −2 % |
| Pfanddachs (1) | 6 | 2.8 s / −1 % | 2.9 s / −0 % | 2.8 s / −0 % |
| Pfanddachs (1) | 10 | 2.5 s / −1 % | 2.1 s / −0 % · | 2.2 s / −0 % · |
| Pfanddachs (1) | 15 | 1.7 s / −0 % · | 1.8 s / −0 % · | 1.8 s / −0 % · |
| Grillgut-Gans * (1) | 1 | 3.9 s / −2 % ⚡ | 4.4 s / −9 % | 5 s / −17 % |
| Grillgut-Gans * (1) | 3 | 3.2 s / −3 % | 3.9 s / −2 % | 3.8 s / −1 % |
...
| Pfandkeiler (2) | 1 | 4.7 s / −11 % | 5.3 s / −22 % | 6 s / −23 % |
| Pfandkeiler (2) | 2 | 4.5 s / −13 % | 4.8 s / −9 % | 5.3 s / −14 % |
| Pfandkeiler (2) | 3 | 4 s / −5 % | 4.4 s / −7 % | 5.1 s / −9 % |
| Pfandkeiler (2) | 6 | 3.6 s / −1 % | 3.4 s / −0 % | 3.6 s / −0 % |
| Pfandkeiler (2) | 10 | 2.7 s / −1 % | 2.6 s / −0 % | 2.5 s / −0 % |
| Pfandkeiler (2) | 15 | 2.3 s / −1 % · | 2.1 s / −0 % · | 2.1 s / −0 % · |
| Ruhewart auf Streife (3) | 1 | 6.9 s / −15 % | 7.2 s / −24 % | 8.1 s / −24 % |
| Ruhewart auf Streife (3) | 3 | 4.3 s / −3 % | 5.7 s / −11 % | 5.7 s / −17 % |
...
| Leergut-Rabe * (1) | 1 | 3.5 s / −2 % ⚡ | 4.2 s / −4 % | 4.8 s / −14 % |
| Leergut-Rabe * (1) | 3 | 3.2 s / −3 % | 3.7 s / −2 % | 3.8 s / −1 % |
...
| Pfandfuchs (2) | 1 | 4.3 s / −8 % | 4.7 s / −14 % | 5 s / −15 % |
| Pfandfuchs (2) | 2 | 3.9 s / −9 % ⚡ | 4.1 s / −11 % | 4.3 s / −8 % |
| Pfandfuchs (2) | 3 | 3.4 s / −4 % | 3.9 s / −8 % | 3.8 s / −5 % |
| Pfandfuchs (2) | 6 | 3.1 s / −1 % | 3 s / −0 % | 3 s / −0 % |
| Pfandfuchs (2) | 10 | 2.5 s / −1 % | 2.4 s / −0 % · | 2.4 s / −0 % · |
| Pfandfuchs (2) | 15 | 2.2 s / −1 % · | 2.1 s / −0 % · | 1.8 s / −0 % · |
| Festzelt-Schnorrer (2) | 1 | 5.8 s / −8 % | 6.3 s / −10 % | 6.8 s / −9 % |
| Festzelt-Schnorrer (2) | 2 | 5.3 s / −9 % | 5.6 s / −7 % | 6 s / −6 % |
| Festzelt-Schnorrer (2) | 3 | 4.3 s / −8 % | 5 s / −3 % | 5.7 s / −7 % |
...
| Ordnungsamt-Praktikant (3) | 1 | 8 s / −16 % | 8.7 s / −26 % | 9.7 s / −29 % |
| Ordnungsamt-Praktikant (3) | 3 | 4.3 s / −3 % | 6.7 s / −15 % | 5.7 s / −17 % |
...
| Kegelbruder aus Kalt (3) | 1 | 7.3 s / −16 % | 7.9 s / −22 % | 8.7 s / −25 % |
| Kegelbruder aus Kalt (3) | 3 | 4.3 s / −10 % | 6.2 s / −12 % | 5.7 s / −10 % |
...
| Junggeselle im Game-Over-Shirt * (4) | 3 | 4.3 s / −4 % | 8.1 s / −18 % | 5.7 s / −13 % |
...
| Borsten-Bruno (4) | 3 | 6.5 s / −24 % | 14.7 s / −39 % | 9.4 s / −31 % |
...
| Oberpraktikant Olaf (4) | 3 | 7 s / −18 % | 14.7 s / −38 % | 11.5 s / −15 % |
...
| Horst Nüchternmann (4) | 3 | 14.6 s / −35 % | 33.2 s / −49 % | 19.8 s / −49 % |
...
| Sperrmüll-Sigi (5) | 3 | 15.6 s / −34 % | 40.1 s / −54 % | 21.5 s / −46 % |
...
- Pfanddachs fällt für dieter auf eigener Stufe in 3.2 s statt mindestens 4 s – zu schnell für den Korridor.
- Grillgut-Gans fällt für dieter auf eigener Stufe in 3.9 s statt mindestens 4 s – zu schnell für den Korridor.
- Leergut-Rabe fällt für dieter auf eigener Stufe in 3.5 s statt mindestens 4 s – zu schnell für den Korridor.
- Pfandfuchs fällt für dieter auf eigener Stufe in 3.9 s statt mindestens 4 s – zu schnell für den Korridor.
...
|---|---:|---:|---|---|---|
| Pfanddachs (1) | 1 | 360 | 3.2 s / −3 % ⚡ | 4.1 s / −3 % | 4.3 s / −8 % |
| Pfanddachs (1) | 3 | 360 | 3.1 s / −3 % | 3.8 s / −2 % | 3.5 s / −2 % |
...
| Grillgut-Gans (1) | 1 | 390 | 3.9 s / −2 % ⚡ | 4.4 s / −9 % | 5 s / −17 % |
| Grillgut-Gans (1) | 3 | 390 | 3.2 s / −3 % | 3.9 s / −2 % | 3.8 s / −1 % |
...
| Pfandkeiler (2) | 3 | 460 | 4 s / −5 % | 4.4 s / −7 % | 5.1 s / −9 % |
...
| Ruhewart auf Streife (3) | 3 | 600 | 4.3 s / −3 % | 5.7 s / −11 % | 5.7 s / −17 % |
...
| Leergut-Rabe (1) | 1 | 380 | 3.5 s / −2 % ⚡ | 4.2 s / −4 % | 4.8 s / −14 % |
| Leergut-Rabe (1) | 3 | 380 | 3.2 s / −3 % | 3.7 s / −2 % | 3.8 s / −1 % |
...
| Pfandfuchs (2) | 3 | 400 | 3.4 s / −4 % | 3.9 s / −8 % | 3.8 s / −5 % |
...
| Festzelt-Schnorrer (2) | 3 | 520 | 4.3 s / −8 % | 5 s / −3 % | 5.7 s / −7 % |
...
| Ordnungsamt-Praktikant (3) | 3 | 700 | 4.3 s / −3 % | 6.7 s / −15 % | 5.7 s / −17 % |
