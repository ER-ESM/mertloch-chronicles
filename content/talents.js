...
export const SPECS={
 ...
 'baerbel-stage':{name:'Filter-Furie',classId:'baerbel',role:'Fernkampf-Schaden',icon:'speaker',text:'Bei 100 Likes beginnt die Putzwut: alles kostenlos, härter und im Laufen. Auswringen beendet sie mit Bonusschaden aus den restlichen Likes.'},
