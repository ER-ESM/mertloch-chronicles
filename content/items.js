...
export const ITEM_CATALOG={
 // --- Startausrüstung ---
 topfdeckel:{look:'Runder verbeulter Topfdeckel mit Holzgriff, dicke Konturen und Honiglicht',name:'Omas unzerstörbarer Topfdeckel',slot:'offhand',shield:true,rarity:'common',icon:'shield',stats:{armorRating:14},value:3,description:'Ein Schild mit Suppengeschichte. Schaltet Schildparaden frei.'},
 ...
 // --- Feste Ausrüstung ---
 dosenbrecher:{weapon:{type:'club',hands:1,min:17,max:24},name:'Dosenbrecher',slot:'weapon',rarity:'uncommon',icon:'reinforced',level:2,value:18,stats:{might:8,finesse:8},description:'Verstärkte Mehrwegtechnik für mehr Wumms und bessere Glückstreffer.'},
 ...
 festivalstiefel:{name:'Matschfeste Festivalstiefel',slot:'feet',rarity:'uncommon',icon:'boots',level:1,value:14,stats:{finesse:15,armorRating:12},description:'Erprobt auf dem schlimmsten Zeltplatz der Eifel.'},
 pfandring:{name:'Ring der ewigen Rückgabe',slot:'ring',rarity:'rare',icon:'ring',level:2,value:32,stats:{wit:20},description:'Der Pfand kommt immer zurück.'},
 hausordnung:{name:'Horsts gelochte Hausordnung',slot:'trinket',rarity:'rare',icon:'paper',level:1,value:50,stats:{wit:25,stamina:8},description:'Endlich zu etwas gut. Ein Andenken an Horsts Niederlage.'},
 ...
 kabelbinderstiefel:{name:'Kabelbinder-Stiefel',slot:'feet',rarity:'rare',icon:'boots',level:4,value:38,stats:{finesse:26,wit:5,armorRating:20},description:'Kevin hat sie „gefixt“. Sie quietschen jetzt im Takt.',look:'Gummistiefel mit bunten Kabelbindern'},
 megafon:{weapon:{type:'speaker',hands:0,min:21,max:34},name:'Annis Hygiene-Hochdruckspray',slot:'ranged',rarity:'rare',icon:'sound',level:6,value:52,stats:{finesse:25,wit:18},description:'Entfernt Flecken, Freundschaften und Rückgaberechte. Nur noch drei Vorführungen bis zur goldenen Vertriebskrone.',look:'Grüne Pumpsprayflasche mit goldenem Provisionsanhänger'},
 // --- Werkbank: gebaute Talismane (schwächer als gewürfelte Seltene derselben Stufe) ---
 kabeltalisman:{name:'Kabelbinder-Talisman',slot:'charm',rarity:'uncommon',icon:'cable',level:4,value:20,stats:{wit:8,stamina:6,finesse:9},description:'Kevins Werkbank, Stufe 2. Sechs Kabel, vier Kronkorken, null Garantie.',look:'Geflochtener Anhänger aus bunten Kabelbindern mit Kronkorken in der Mitte'},
 blechtalisman:{name:'Dosenblech-Talisman',slot:'charm',rarity:'uncommon',icon:'metal',level:8,value:36,stats:{might:10,stamina:9,wit:6,finesse:12},description:'Kevins Werkbank, Stufe 3. Gehämmertes Dosenblech mit Borsten als Fransen.',look:'Gehämmerte Blechscheibe mit Keilerborsten am Rand, Flugblattschnipsel eingeklebt'},
 // --- Dorflegenden (einzigartig, mit Effekt) ---
 keilerzahn:{look:'Gebogener gelber Hauer an einer Lederschnur, Kerbe an der Spitze',name:'Hauers letzter Zahn',slot:'charm',rarity:'epic',icon:'ring',level:2,stats:{might:14,stamina:9,finesse:15},unique:true,proc:'rage',description:'Selten aus Pfandkeilern: Glückstreffer geben 4 Randale zurück.'},
 gansorden:{look:'Blecherner Orden mit Gänsekopf-Prägung an rot-weißem Band',name:'Orden der unverschämten Gans',slot:'charm',rarity:'epic',icon:'paper',level:1,stats:{finesse:27},unique:true,proc:'fleet',description:'Selten aus Grillgut-Gänsen: Ausweichen wird 15 % schneller bereit.'},
 dachsdeckel:{look:'Zerzauste Dachsfellmütze mit Schnauze als Schirm',name:'Dachsdeckel des Unbeugsamen',slot:'charm',rarity:'epic',icon:'shield',level:1,stats:{stamina:14,armorRating:45},unique:true,proc:'stout',description:'Selten aus Pfanddachsen: 8 % weniger Schaden bei weniger als 35 % Leben.'},
 ruhepfeife:{look:'Verchromte Trillerpfeife mit Gravur „22:01“ an einer Kordel',weapon:{type:'speaker',hands:0,min:21,max:35},name:'Trillerpfeife der Ruhestörung',slot:'ranged',rarity:'epic',icon:'sound',level:2,stats:{wit:33,finesse:9},unique:true,proc:'silence',description:'Selten aus Ruhewärtern: Unterbrechen lädt 10 zusätzliche Randale.'},
 horststempel:{look:'Schwerer Bürostempel mit Holzgriff, Stempelplatte „ABGELEHNT“',weapon:{type:'maul',hands:2,min:33,max:47},name:'Horsts endgültige Ablehnung',slot:'weapon',rarity:'epic',icon:'reinforced',level:3,stats:{might:18,finesse:28,wit:18},unique:true,proc:'verdict',description:'Selten von Horst. Markierte Ziele erleiden weitere 10 % Schaden. Der Stempel sagt NEIN.'},
 fuchspfote:{name:'Glückspfote des Pfandfuchses',slot:'feet',rarity:'epic',icon:'boots',level:3,stats:{finesse:32,stamina:6,armorRating:18},unique:true,proc:'fleet',description:'Selten aus Pfandfüchsen: Ausweichen wird 15 % schneller bereit. Der Fuchs vermisst sie.',look:'Rostrote Pfote als Anhänger an einem Stiefel'},
 schnorrerbecher:{name:'Der nie leere Schnorrerbecher',slot:'charm',rarity:'epic',icon:'water',level:3,stats:{wit:27,stamina:10},unique:true,proc:'thirst',description:'Selten aus Festzelt-Schnorrern: Jeder Kill gibt 20 Randale zurück. Irgendjemand zahlt immer.',look:'Zerkratzter Plastikbecher mit Pfandaufkleber'},
 praktikantenausweis:{name:'Laminierter Praktikantenausweis',slot:'charm',rarity:'epic',icon:'paper',level:4,stats:{wit:27,finesse:22},unique:true,proc:'verdict',description:'Selten aus Ordnungsamt-Praktikanten: Markierte Ziele erleiden weitere 10 % Schaden. „Bin nur Praktikant.“',look:'Laminierter Ausweis mit Passbild und Schnur'}, dienstmuetze:{name:'Olafs Dienstmütze',slot:'head',rarity:'epic',icon:'helmet',level:4,stats:{stamina:13,wit:11,finesse:18,armorRating:38},unique:true,proc:'silence',description:'Selten von Oberpraktikant Olaf: Unterbrechen lädt 10 zusätzliche Randale. Zwei Nummern zu groß, ein Vermerk zu viel.',look:'Graue Dienstmütze mit steifem Schirm, silbernes Ordnungsamt-Abzeichen, innen Namensschild „i. A. Olaf“, Schweißrand'},
 // --- Akt 1: Dorflegenden ---
 kegelkugel:{name:'Die Kugel vom Dorfpokal 2011',slot:'charm',rarity:'epic',icon:'reinforced',level:3,stats:{might:14,stamina:9,finesse:11},unique:true,proc:'rage',description:'Selten aus Kegelbrüdern: Glückstreffer geben 4 Randale zurück. Dieter hat sie „nur ausgeliehen“. Seit 2011.',look:'Schwere schwarze Kegelkugel mit drei Löchern und eingeritztem „PT 2011“'},
 bierbong:{name:'Bierbong des Junggesellen',slot:'charm',rarity:'epic',icon:'water',level:4,stats:{might:12,stamina:12,finesse:12},unique:true,proc:'thirst',description:'Selten aus Junggesellen: Jeder Kill gibt 20 Randale zurück. Trichter, Schlauch, null Würde.',look:'Roter Trichter mit durchsichtigem Schlauch, Aufkleber „BASTIANS LETZTE NACHT“'},
 sigizange:{weapon:{type:'maul',hands:2,min:36,max:50},name:'Sigis Greifzange',slot:'weapon',rarity:'epic',icon:'reinforced',level:5,stats:{might:20,stamina:16,wit:30},unique:true,proc:'stout',description:'Selten von Sigi. 8 % weniger Schaden bei weniger als 35 % Leben. Greift alles. Gibt nichts zurück.',look:'Verrostete Schrott-Greifzange mit Holzgriff und Kette, ölige Backen'},
 koenigskette:{name:'Die Kegelkönig-Kette',slot:'charm',rarity:'epic',icon:'necklace',level:6,stats:{finesse:33,wit:14,stamina:10},unique:true,proc:'rage',description:'Selten von Klaus. Glückstreffer geben 4 Randale zurück. Vergoldet, Plakette „2011 – ABERKANNT“.',look:'Goldene Kette mit Kegel-Anhänger und kleiner Plakette, ein Glied geflickt'},
 schaerpe:{name:'Die Schärpe der Wahrheit',slot:'charm',rarity:'epic',icon:'coat',level:7,stats:{stamina:18,might:14,finesse:34},unique:true,proc:'fleet',description:'Selten von Timo. Ausweichen wird 15 % schneller bereit. Aufdruck „TRAUZEUGE“, Rückseite mit Edding: „UND DU?“',look:'Rote Satin-Schärpe mit Goldschrift „TRAUZEUGE“, Bierflecken, Edding auf der Rückseite'},
 giesskanne:{weapon:{type:'maul',hands:2,min:37,max:53},name:'Giselas Gießkanne der Gerechtigkeit',slot:'weapon',rarity:'epic',icon:'water',level:6,stats:{might:20,wit:42,stamina:12},unique:true,proc:'hops',description:'Selten von Gisela. Außerhalb des Kampfes regenerierst du doppelt so schnell. Innen: Hopfen, kein Wasser.',look:'Grüne Blechgießkanne mit Vereinsaufkleber „Ruhe 22:01“'},
 automatenarm:{name:'Greifarm des Pfandautomaten',slot:'charm',rarity:'epic',icon:'reinforced',level:9,stats:{might:22,finesse:45,wit:22,stamina:14},unique:true,proc:'thirst',description:'Selten vom Pfandautomaten 3000. Jeder Kill gibt 20 Randale zurück. Nimmt weiterhin keine Dosen an.',look:'Verchromter Roboter-Greifarm mit blinkender LED'}
};
