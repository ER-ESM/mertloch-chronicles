...
export const ITEM_CATALOG={
 ...
 // --- Feste Ausrüstung ---
 dosenbrecher:{weapon:{type:'club',hands:1,min:17,max:24},name:'Dosenbrecher',slot:'weapon',rarity:'uncommon',icon:'reinforced',level:2,value:18,stats:{might:8,critRating:10},description:'Verstärkte Mehrwegtechnik für mehr Wumms und bessere Glückstreffer.'},
 ...
 pfandring:{name:'Ring der ewigen Rückgabe',slot:'ring',rarity:'rare',icon:'ring',level:2,value:32,stats:{wit:8,masteryRating:15},description:'Der Pfand kommt immer zurück.'},
 ...
 kabeltalisman:{name:'Kabelbinder-Talisman',slot:'charm',rarity:'uncommon',icon:'cable',level:4,value:20,stats:{wit:8,stamina:6,hasteRating:12},description:'Kevins Werkbank, Stufe 2: 8 Bastelgrips, 6 Standfestigkeit, 12 Drehzahl. Sechs Kabel, vier Kronkorken, null Garantie.',look:'Geflochtener Anhänger aus bunten Kabelbindern mit Kronkorken in der Mitte'},
 blechtalisman:{name:'Dosenblech-Talisman',slot:'charm',rarity:'uncommon',icon:'metal',level:8,value:36,stats:{might:10,stamina:9,wit:6,critRating:16},description:'Kevins Werkbank, Stufe 3: 10 Wumms, 9 Standfestigkeit, 6 Bastelgrips, 16 Glückstreffer. Gehämmertes Dosenblech mit Borsten als Fransen.',look:'Gehämmerte Blechscheibe mit Keilerborsten am Rand, Flugblattschnipsel eingeklebt'},
 // --- Dorflegenden (einzigartig, mit Effekt) ---
 keilerzahn:{look:'Gebogener gelber Hauer an einer Lederschnur, Kerbe an der Spitze',name:'Hauers letzter Zahn',slot:'charm',rarity:'epic',icon:'ring',level:2,stats:{might:14,stamina:9,critRating:20},unique:true,proc:'rage',description:'Selten aus Pfandkeilern: Glückstreffer geben 4 Randale zurück.'},
 gansorden:{look:'Blecherner Orden mit Gänsekopf-Prägung an rot-weißem Band',name:'Orden der unverschämten Gans',slot:'charm',rarity:'epic',icon:'paper',level:1,stats:{finesse:12,hasteRating:20},unique:true,proc:'fleet',description:'Selten aus Grillgut-Gänsen: Ausweichen wird 15 % schneller bereit.'},
 ...
 ruhepfeife:{look:'Verchromte Trillerpfeife mit Gravur „22:01“ an einer Kordel',weapon:{type:'speaker',hands:0,min:21,max:35},name:'Trillerpfeife der Ruhestörung',slot:'ranged',rarity:'epic',icon:'sound',level:2,stats:{wit:15,masteryRating:24,critRating:12},unique:true,proc:'silence',description:'Selten aus Ruhewärtern: Unterbrechen lädt 10 zusätzliche Randale.'},
 horststempel:{look:'Schwerer Bürostempel mit Holzgriff, Stempelplatte „ABGELEHNT“',weapon:{type:'maul',hands:2,min:33,max:47},name:'Horsts endgültige Ablehnung',slot:'weapon',rarity:'epic',icon:'reinforced',level:3,stats:{might:18,finesse:18,wit:18,critRating:25},unique:true,proc:'verdict',description:'Selten von Horst. Markierte Ziele erleiden weitere 10 % Schaden. Der Stempel sagt NEIN.'},
 ...
 praktikantenausweis:{name:'Laminierter Praktikantenausweis',slot:'charm',rarity:'epic',icon:'paper',level:4,stats:{wit:16,finesse:10,critRating:16,masteryRating:14},unique:true,proc:'verdict',description:'Selten aus Ordnungsamt-Praktikanten: Markierte Ziele erleiden weitere 10 % Schaden. „Bin nur Praktikant.“',look:'Laminierter Ausweis mit Passbild und Schnur'}, dienstmuetze:{name:'Olafs Dienstmütze',slot:'head',rarity:'epic',icon:'helmet',level:4,stats:{stamina:13,wit:11,finesse:7,armorRating:38,critRating:14},unique:true,proc:'silence',description:'Selten von Oberpraktikant Olaf: Unterbrechen lädt 10 zusätzliche Randale. Zwei Nummern zu groß, ein Vermerk zu viel.',look:'Graue Dienstmütze mit steifem Schirm, silbernes Ordnungsamt-Abzeichen, innen Namensschild „i. A. Olaf“, Schweißrand'},
 // --- Akt 1: Dorflegenden ---
 kegelkugel:{name:'Die Kugel vom Dorfpokal 2011',slot:'charm',rarity:'epic',icon:'reinforced',level:3,stats:{might:14,stamina:9,critRating:14},unique:true,proc:'rage',description:'Selten aus Kegelbrüdern: Glückstreffer geben 4 Randale zurück. Dieter hat sie „nur ausgeliehen“. Seit 2011.',look:'Schwere schwarze Kegelkugel mit drei Löchern und eingeritztem „PT 2011“'},
 bierbong:{name:'Bierbong des Junggesellen',slot:'charm',rarity:'epic',icon:'water',level:4,stats:{might:12,stamina:12,hasteRating:16},unique:true,proc:'thirst',description:'Selten aus Junggesellen: Jeder Kill gibt 20 Randale zurück. Trichter, Schlauch, null Würde.',look:'Roter Trichter mit durchsichtigem Schlauch, Aufkleber „BASTIANS LETZTE NACHT“'},
 sigizange:{weapon:{type:'maul',hands:2,min:36,max:50},name:'Sigis Greifzange',slot:'weapon',rarity:'epic',icon:'reinforced',level:5,stats:{might:20,stamina:16,wit:12,masteryRating:24},unique:true,proc:'stout',description:'Selten von Sigi. 8 % weniger Schaden bei weniger als 35 % Leben. Greift alles. Gibt nichts zurück.',look:'Verrostete Schrott-Greifzange mit Holzgriff und Kette, ölige Backen'},
 koenigskette:{name:'Die Kegelkönig-Kette',slot:'charm',rarity:'epic',icon:'necklace',level:6,stats:{finesse:16,wit:14,stamina:10,critRating:22},unique:true,proc:'rage',description:'Selten von Klaus. Glückstreffer geben 4 Randale zurück. Vergoldet, Plakette „2011 – ABERKANNT“.',look:'Goldene Kette mit Kegel-Anhänger und kleiner Plakette, ein Glied geflickt'},
 schaerpe:{name:'Die Schärpe der Wahrheit',slot:'charm',rarity:'epic',icon:'coat',level:7,stats:{stamina:18,might:14,finesse:14,hasteRating:26},unique:true,proc:'fleet',description:'Selten von Timo. Ausweichen wird 15 % schneller bereit. Aufdruck „TRAUZEUGE“, Rückseite mit Edding: „UND DU?“',look:'Rote Satin-Schärpe mit Goldschrift „TRAUZEUGE“, Bierflecken, Edding auf der Rückseite'},
