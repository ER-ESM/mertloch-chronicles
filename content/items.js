...
export const ITEM_CATALOG={
 ...
 keilerzahn:{look:'Gebogener gelber Hauer an einer Lederschnur, Kerbe an der Spitze',name:'Hauers letzter Zahn',slot:'charm',rarity:'epic',icon:'ring',level:2,stats:{might:2,stamina:1,finesse:2},unique:true,proc:'rage',description:'Selten aus Pfandkeilern: Glückstreffer geben 4 Randale zurück.'},
 ...
 schnorrerbecher:{name:'Der nie leere Schnorrerbecher',slot:'charm',rarity:'epic',icon:'water',level:3,stats:{wit:5,stamina:2},unique:true,proc:'thirst',description:'Selten aus Festzelt-Schnorrern: Jeder Kill gibt 20 Randale zurück. Irgendjemand zahlt immer.',look:'Zerkratzter Plastikbecher mit Pfandaufkleber'},
 praktikantenausweis:{name:'Laminierter Praktikantenausweis',slot:'charm',rarity:'epic',icon:'paper',level:4,stats:{wit:5,finesse:4},unique:true,proc:'verdict',description:'Selten aus Ordnungsamt-Praktikanten: Markierte Ziele erleiden weitere 10 % Schaden. „Bin nur Praktikant.“',look:'Laminierter Ausweis mit Passbild und Schnur'}, gaesteliste:{look:'Klemmbrett mit leerer Gästeliste, Kugelschreiber an einer Schnur, Aufkleber „VIP“ halb abgekratzt',name:'Die Gästeliste',slot:'charm',rarity:'epic',icon:'paper',level:9,stats:{wit:6,finesse:6,stamina:5},unique:true,proc:'silence',description:'Selten von Gästeliste-Gerd im Schloss Big B: Unterbrechen lädt zusätzliche Randale. „Du stehst auf jeder Liste. Auf keiner steht was.“'},
 // Big B (Etappe 3, E-71; Plan 11): zwei Dorflegenden je 12 % aus der Beutetabelle bigb.
 'siegelring-echtgold':{look:'Messingring mit breiter Siegelplatte, Goldlack blättert an den Kanten ab, verschnörkeltes „B“',name:'Siegelring „Echt Gold“',slot:'ring',rarity:'epic',icon:'ring',level:10,stats:{might:6,finesse:6,stamina:6},unique:true,proc:'verdict',description:'Selten von Big B im Schloss Big B: Markierte Ziele erleiden weitere 10 % Schaden. „Echt. Gold. Farbe.“'},
 'pelzmantel-baron':{look:'Knielanger Kunstpelzmantel mit Plüschkragen, im Futter steckt noch der Leihzettel vom Kostümverleih',name:'Pelzmantel des Barons',slot:'body',rarity:'epic',icon:'coat',level:10,stats:{stamina:7,wit:5,finesse:4,armorRating:3},unique:true,proc:'stout',description:'Selten von Big B im Schloss Big B: 8 % weniger Schaden bei weniger als 35 % Leben. „Echtpelz. Vom Kostümverleih. Echt geliehen.“'},
 ...
 // --- Akt 1: Dorflegenden ---
 kegelkugel:{name:'Die Kugel vom Dorfpokal 2011',slot:'charm',rarity:'epic',icon:'reinforced',level:3,stats:{might:3,stamina:2,finesse:2},unique:true,proc:'rage',description:'Selten aus Kegelbrüdern: Glückstreffer geben 4 Randale zurück. Dieter hat sie „nur ausgeliehen“. Seit 2011.',look:'Schwere schwarze Kegelkugel mit drei Löchern und eingeritztem „PT 2011“'},
 bierbong:{name:'Bierbong des Junggesellen',slot:'charm',rarity:'epic',icon:'water',level:4,stats:{might:3,stamina:3,finesse:3},unique:true,proc:'thirst',description:'Selten aus Junggesellen: Jeder Kill gibt 20 Randale zurück. Trichter, Schlauch, null Würde.',look:'Roter Trichter mit durchsichtigem Schlauch, Aufkleber „BASTIANS LETZTE NACHT“'},
 ...
 koenigskette:{name:'Die Kegelkönig-Kette',slot:'charm',rarity:'epic',icon:'necklace',level:6,stats:{finesse:8,wit:3,stamina:2},unique:true,proc:'rage',description:'Selten von Klaus. Glückstreffer geben 4 Randale zurück. Vergoldet, Plakette „2011 – ABERKANNT“.',look:'Goldene Kette mit Kegel-Anhänger und kleiner Plakette, ein Glied geflickt'},
