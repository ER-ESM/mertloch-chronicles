...
export const ITEM_INFO={
 ...
 gaesteliste:{effect:'Dorflegende aus dem Schloss mit Bastelgrips, Taktgefühl und Standfestigkeit; ihr Proc füllt beim Unterbrechen zusätzlich deine Klassenressource.',
  why:'Gerds Liste belohnt, was sein Kampf lehrt: rechtzeitig unterbrechen. Als Talisman passt sie in jeden Bau, auch neben Olafs Mütze.',
  links:['silence','dienstmuetze','ruhepfeife'],terms:['dorflegende','proc','unterbrechen','wit','stamina']},
 'siegelring-echtgold':{effect:'Dorflegende aus dem Thronsaal mit Wumms, Taktgefühl und Standfestigkeit; ihr Proc erhöht den Schaden auf markierte Ziele.',
  why:'Big Bs Ring belohnt, was sein Kampf verlangt: erst lesen, dann zuschlagen. Als Ring passt er in jeden Bau.',
  links:['verdict','praktikantenausweis','gaesteliste'],terms:['dorflegende','proc','markierung','might','stamina']},
 'pelzmantel-baron':{effect:'Dorflegende für die Brust mit Standfestigkeit, Bastelgrips und Dicke Haut; ihr Proc dämpft Treffer, wenn es eng wird.',
  why:'Geliehen, aber warm: der Mantel hält, wenn die Kanonenkugel doch trifft.',
  links:['stout','dachsdeckel','siegelring-echtgold'],terms:['dorflegende','proc','stamina','armorRating']},
 // Etappe 4 Teil A (E-71): Dorflegenden der restlichen Schlossbosse
 'hochglanz-expose':{effect:'Dorflegende für die Nebenhand mit Bastelgrips, Taktgefühl und Standfestigkeit; ihr Proc erhöht den Schaden auf markierte Ziele.',
  why:'Frau Dr. Exposés Mappe belohnt, was ihr Kampf lehrt: das richtige Ziel zuerst. Als Nebenhand passt sie zu jeder Einhandwaffe.',
  links:['verdict','siegelring-echtgold','gaesteliste'],terms:['dorflegende','proc','markierung','wit','stamina']},
 'korkenzieher-kellermeister':{effect:'Einhandwaffe des Kellermeisters mit Wumms, Taktgefühl und Standfestigkeit; ihr Proc füllt bei Glückstreffern deine Klassenressource.',
  why:'Kurts Korkenzieher belohnt, wer zwischen Sammeln, Verteilen und Fässern weiterschlägt: jeder Glückstreffer füllt nach.',
  links:['rage','kegelkugel','hochglanz-expose'],terms:['dorflegende','proc','glueckstreffer','ressource','might']},
 'halbes-hufeisen':{effect:'Dorflegende aus den Stallungen mit Taktgefühl, Standfestigkeit und Bastelgrips; ihr Proc macht Ausweichen schneller bereit.',
  why:'Das halbe Pferd lehrt, rechtzeitig vom Trog und aus dem Wiehern zu gehen. Das Hufeisen belohnt genau das.',
  links:['fleet','fuchspfote','ringlicht-reichweite'],terms:['dorflegende','proc','ausweichen','tempo','stamina']},
 'ringlicht-reichweite':{effect:'Dorflegende aus dem Presseamt mit Bastelgrips, Taktgefühl und Standfestigkeit; ihr Proc macht Ausweichen schneller bereit.',
  why:'Ritas Ringlicht belohnt, was ihr Kampf verlangt: rechtzeitig aus dem Blitz. Als Talisman passt es in jeden Bau.',
  links:['fleet','fuchspfote','gaesteliste'],terms:['dorflegende','proc','ausweichen','tempo','stamina']},
