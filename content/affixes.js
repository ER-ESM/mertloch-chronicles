...
export const LOOT_PREFIXES=[
 ...
 P('kirmes','Kirmes-',1,30,['alle'],ALL,{hasteRating:1}),
 P('geklaut','Geklaut',1,30,['alle'],ALL,{critRating:1}),
 P('dorfdisko','Dorfdisko-',1,30,['alle'],ALL,{finesse:.6,hasteRating:.4}),
 P('stammtisch','Stammtisch-',1,30,['alle'],ALL,{might:.6,stamina:.4}),
 P('bauwagen','Bauwagen-',1,30,['alle'],ALL,{wit:.6,masteryRating:.4}),
 ...
 P('rostig','Rostig',1,12,['waffe','schmuck'],ALL,{critRating:.6,might:.4}),
 P('versifft','Versifft',1,12,['alle'],ALL,{stamina:.6,masteryRating:.4}),
 P('ausgeleiert','Ausgeleiert',1,12,['ruestung','schmuck'],ALL,{hasteRating:.7,finesse:.3}),
 P('angekokelt','Angekokelt',1,14,['alle'],ALL,{wit:.5,critRating:.5}),
 P('sperrmuell','Sperrmüll-',1,14,['alle'],ALL,{might:.5,armorRating:.5}),
 P('flohmarkt','Flohmarkt-',1,14,['alle'],ALL,{wit:.5,hasteRating:.5}),
 P('krumm','Krumm',1,12,['waffe'],ALL,{critRating:1}),
 ...
 P('frischgezapft','Frisch gezapft',8,22,['alle'],ALL,{stamina:.5,hasteRating:.5}),
 P('schuetzenfest','Schützenfest-',8,22,['alle'],ALL,{critRating:.6,finesse:.4}),
 P('polterabend','Polterabend-',8,22,['alle'],ALL,{might:.5,critRating:.5}),
 P('fruehschoppen','Frühschoppen-',8,22,['alle'],ALL,{stamina:.6,masteryRating:.4}),
 P('feuerwehrfest','Feuerwehrfest-',8,22,['alle'],ALL,{armorRating:.5,might:.5}),
 P('bierselig','Bierselig',8,22,['ruestung','schmuck'],ALL,{masteryRating:.6,stamina:.4}),
 P('wetterfest','Wetterfest',8,24,['ruestung'],ALL,{armorRating:.7,stamina:.3}),
 P('frischgeoelt','Frisch geölt',8,24,['waffe','schmuck'],ALL,{hasteRating:1}),
 P('doppeltgeklebt','Doppelt geklebt',8,22,['alle'],ALL,{wit:.6,armorRating:.4}),
 P('frisiert','Frisiert',8,24,['waffe','schmuck'],ALL,{hasteRating:.6,critRating:.4}),
 P('trecker','Trecker-',8,24,['alle'],ALL,{might:.7,stamina:.3}),
 P('weinfest','Weinfest-',8,22,['alle'],ALL,{finesse:.5,masteryRating:.5}),
 P('vatertags','Vatertags-',8,22,['alle'],ALL,{might:.4,hasteRating:.6}),
 P('zeltlager','Zeltlager-',8,22,['ruestung','schmuck'],ALL,{stamina:.5,finesse:.5}),
 // --- Stufe 16–30: Dorfprominenz ---
 P('tiefergelegt','Tiefergelegt',16,30,['alle'],ALL,{finesse:.6,critRating:.4}),
 P('aufgemotzt','Aufgemotzt',16,30,['alle'],ALL,{might:.5,critRating:.5}),
 P('verchromt','Verchromt',16,30,['alle'],ALL,{wit:.5,armorRating:.5}),
 P('praemiert','Prämiert',16,30,['alle'],ALL,{masteryRating:1}),
 P('handsigniert','Handsigniert',16,30,['alle'],ALL,{wit:.6,masteryRating:.4}),
 P('rosenmontags','Rosenmontags-',16,30,['alle'],ALL,{finesse:.5,hasteRating:.5}),
 P('kreisliga','Kreisliga-',16,30,['alle'],ALL,{might:.6,hasteRating:.4}),
 ...
 P('vergoldet','Vergoldet',12,30,['alle'],FINE,{critRating:.5,masteryRating:.5}),
 P('sagenhaft','Sagenhaft',1,30,['alle'],FINE,{might:.5,finesse:.5}),
 P('beruechtigt','Berüchtigt',1,30,['alle'],FINE,{critRating:.7,hasteRating:.3}),
 P('dorfbekannt','Dorfbekannt',1,30,['alle'],FINE,{stamina:.5,wit:.5}),
 P('eifelweit','Eifelweit gefürchtet',20,30,['alle'],['epic'],{might:.4,critRating:.6})
];

/** Beinamen: woher das Teil stammt und was daran faul ist. Stehen hinter dem Spec-Nachsatz. */
export const LOOT_EPITHETS=[
 // --- überall, jede Stufe ---
 E('ohne-tuev','ohne TÜV',1,30,['alle'],ALL,{critRating:1}),
 E('omas-keller','aus Omas Keller',1,30,['alle'],ALL,{stamina:1}),
 E('mit-pfandbon','mit Pfandbon',1,30,['alle'],ALL,{wit:.6,hasteRating:.4}),
 E('vom-stammtisch','vom Stammtisch',1,30,['alle'],ALL,{might:.6,masteryRating:.4}),
 E('nach-feierabend','nach Feierabend',1,30,['alle'],ALL,{finesse:.6,stamina:.4}),
 E('auf-pump','auf Pump',1,30,['alle'],ALL,{hasteRating:1}),
 // --- Stufe 1–12 ---
 E('vom-sperrmuell','vom Sperrmüll',1,12,['alle'],ALL,{armorRating:.5,might:.5}),
 E('zweiter-wahl','zweiter Wahl',1,12,['alle'],ALL,{stamina:.6,critRating:.4}),
 E('vom-wuehltisch','vom Wühltisch',1,12,['alle'],ALL,{wit:.5,critRating:.5}),
 E('mit-bierfleck','mit Bierfleck',1,14,['ruestung','schmuck'],ALL,{stamina:.7,masteryRating:.3}),
 E('grabbelkiste','aus der Grabbelkiste',1,12,['alle'],ALL,{finesse:.5,hasteRating:.5}),
 E('ohne-kassenbon','ohne Kassenbon',1,14,['alle'],ALL,{critRating:.6,finesse:.4}),
 ...
 E('vom-schwager','vom Schwager geliehen',1,14,['alle'],ALL,{might:.4,hasteRating:.6}),
 E('mit-wackelkontakt','mit Wackelkontakt',1,12,['waffe','schmuck'],ALL,{critRating:.5,hasteRating:.5}),
 // --- Stufe 8–22 ---
 E('aus-der-tombola','aus der Tombola',8,22,['alle'],ALL,{critRating:.7,stamina:.3}),
 E('vom-polterabend','vom letzten Polterabend',8,22,['alle'],ALL,{might:.6,critRating:.4}),
 E('vom-feuerwehrfest','vom Feuerwehrfest',8,22,['alle'],ALL,{armorRating:.5,stamina:.5}),
 E('aus-dem-vereinsheim','aus dem Vereinsheim',8,22,['alle'],ALL,{masteryRating:.6,stamina:.4}),
 E('vom-fruehschoppen','vom Frühschoppen',8,22,['alle'],ALL,{stamina:.5,hasteRating:.5}),
 E('mit-edding','mit Edding-Widmung',8,24,['alle'],ALL,{wit:.5,masteryRating:.5}),
 ...
 E('aus-dem-festzelt','aus dem Festzelt',8,22,['alle'],ALL,{finesse:.6,masteryRating:.4}),
 E('in-uebergroesse','in Übergröße',8,24,['ruestung'],ALL,{armorRating:.6,stamina:.4}),
 E('mit-anlauf','mit Anlauf',8,24,['waffe','schmuck'],ALL,{hasteRating:.5,might:.5}),
 E('aus-dem-bauwagen','aus dem Bauwagen',8,22,['alle'],ALL,{wit:.6,critRating:.4}),
 E('vom-weinfest','vom Weinfest',8,22,['alle'],ALL,{finesse:.5,critRating:.5}),
 // --- Stufe 16–30 ---
 E('mit-nachbrenner','mit Nachbrenner',16,30,['waffe','schmuck'],ALL,{hasteRating:.6,critRating:.4}),
 E('vom-schuetzenkoenig','vom Schützenkönig',16,30,['alle'],ALL,{critRating:.6,finesse:.4}),
 E('dorfpokal-gravur','mit Dorfpokal-Gravur',16,30,['alle'],ALL,{masteryRating:.5,might:.5}),
 E('aus-der-kreisliga','aus der Kreisliga',16,30,['alle'],ALL,{might:.5,hasteRating:.5}),
 E('mit-blaulicht','mit Blaulicht',16,30,['alle'],ALL,{wit:.5,hasteRating:.5}),
 E('asservatenkammer','aus der Asservatenkammer',16,30,['alle'],ALL,{wit:.6,armorRating:.4}),
 E('mit-ehrenurkunde','mit Ehrenurkunde',16,30,['alle'],ALL,{masteryRating:.6,stamina:.4}),
 E('vom-open-air','vom Maifeld-Open-Air',16,30,['alle'],ALL,{finesse:.6,hasteRating:.4}),
 ...
 // --- nur Selten/Episch ---
 E('vom-buergermeister','vom Bürgermeister persönlich',1,30,['alle'],FINE,{masteryRating:.5,wit:.5}),
 E('aus-meisterhand','aus Meisterhand',1,30,['alle'],FINE,{might:.5,critRating:.5}),
 E('mit-goldrand','mit Goldrand',1,30,['alle'],FINE,{finesse:.5,masteryRating:.5}),
 E('fuer-fortgeschrittene','für Fortgeschrittene',10,30,['alle'],FINE,{critRating:.5,hasteRating:.5}),
 E('von-der-man-spricht','von dem das Dorf spricht',20,30,['alle'],['epic'],{stamina:.4,critRating:.6})
];
