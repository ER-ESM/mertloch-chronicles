...
export const LORE={
 ...
 clan:'Der Poo-Tang-Clan: Kisten-Ida, Dosen-Dieter, Aperol-Anni, Klo-Kevin und Anhang – Schwenker-Schorsch von der Grillhütte und Kreuz-Käthe vom Freitagsstammtisch. Sie sind hier geboren, hier geblieben und waren noch nie leise. Ihr Treffpunkt ist „die Bude“, eine ehemalige Milchsammelstelle hinter St. Gangolf, die seit 2007 als Vereinsheim dient, obwohl es gar keinen Verein gibt.',
...
export const STORY_CHAPTERS=[
 ...
 {id:2,act:1,title:'Wiederaufbau mit Restpromille',boss:'sigi',dialogue:'wiederaufbau',implemented:false,requires:1,
  ...
  objectives:[{kind:'gather',item:'palettenholz',count:6,label:'Palettenholz vom Sperrmüllplatz holen'},{kind:'kill',family:'scrounger',count:4,place:'Baustelle',label:'Festzelt-Schnorrer von der Baustelle scheuchen'},{kind:'boss',boss:'sigi',place:'Sperrmüllplatz',label:'Sperrmüll-Sigi den Tresen abnehmen'}],
 ...
 {id:3,act:1,title:'Alle Neune, kein Alibi',boss:'klaus',dialogue:'kegelclub',implemented:false,requires:2,
  ...
  objectives:[{kind:'kill',family:'kegler',count:5,place:'Festplatz',label:'Kegelbrüder aus Kalt vom Festplatz kegeln'},{kind:'gather',item:'kabel',count:5,label:'Anlagenkabel von der zerlegten Kegelbahn holen'},{kind:'boss',boss:'klaus',place:'Kegelbahn',label:'Kegelkönig Klaus zur Aussage bewegen'}],
 ...
 {id:4,act:1,title:'Der Bus nach nirgendwo',boss:'timo',dialogue:'bus',implemented:false,requires:3,
  ...
  objectives:[{kind:'kill',family:'jga',count:6,place:'Pits Revier',label:'Junggesellen einsammeln, bevor Pit es tut'},{kind:'gather',item:'jga-shirt',count:4,label:'GAME-OVER-Shirts als Beweise sichern'},{kind:'boss',boss:'timo',place:'Busdach',label:'Trauzeuge Timo vom Busdach holen'}],
 ...
 {id:5,act:2,reserve:true,title:'Der grüne Daumen der Macht',boss:'gisela',dialogue:'chapter2',implemented:false,requires:4,
  ...
  objectives:[{kind:'kill',family:'inspector',count:4,place:'Amtsparkplatz',label:'Ordnungsamt-Praktikanten vertreiben'},{kind:'gather',item:'hopfen',count:5,label:'Wilden Eifelhopfen für Hedwig sichern'},{kind:'boss',boss:'gisela',place:'Giselas Beet',label:'Gisela im Beet stellen'}],
 ...
 {id:6,act:2,reserve:true,title:'Nicht angenommen',boss:'automat',dialogue:'chapter3',implemented:false,requires:5,
  ...
  objectives:[{kind:'gather',item:'dosenblech',count:6,label:'Dosenblech vom Automaten sammeln'},{kind:'kill',family:'scrounger',count:5,place:'Automatenplatz',label:'Festzelt-Schnorrer vom Automaten fernhalten'},{kind:'boss',boss:'automat',place:'Pfandautomat',label:'Den Pfandautomaten 3000 abschalten'}],
