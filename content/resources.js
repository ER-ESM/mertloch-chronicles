...
export const RESOURCES={
 ...
 baerbel:{kind:'trend',name:'Likes',unit:'Likes',max:100,start:60,color:'#ff8f5a',
  restRegen:5,
  trend:{max:5,names:['Flop','Nische','Läuft','Viral','Trending','Aperol-Hype'],likes:[4,7,10,13,16,20],bonusPerLevel:.06,decayAfter:3.5,shitstorm:.12,viralFree:1,viewers:[12,180,1400,9800,64000,480000]},
  beat:{likes:10},
  grantRate:1,
