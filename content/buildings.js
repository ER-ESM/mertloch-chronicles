...
export const BUILDING_EFFECT_INFO={
 ...
 foodHeal:{name:'Wirkung der Verpflegung',kind:'pctAdd',unit:'%',
  label:'Heilung und Klassenressource aus Verpflegung (Anteil)',
  short:'Brezel, Bier und Bratwurst geben um diesen Anteil mehr Leben und mehr Klassenressource.',
 ...
 buffDuration:{name:'Dauer der Stärkung',kind:'pctAdd',unit:'%',
  ...
  long:'Nur die eigene Stärkung der Klasse (Dieters Bier, Annis Aperol, Kevins Ladedruck; Schorschs Blasebalg und Käthes Neu geben bleiben, wie sie sind), nicht die Procs der Dorflegenden. Die Abklingzeit bleibt gleich, das Fenster wird größer.',
 ...
 energyOnKill:{name:'Ressource je Kill',kind:'flat',unit:'Ressourcenpunkte je Kill',
  label:'Ressource je Kill (flach)',
  short:'Jeder erledigte Gegner schenkt dir so viele Ressourcenpunkte – Randale, Likes, Leergut, Glut oder Augen, je nach Klasse.',
 ...
 grill:{name:'Oskars Grill',owner:'oskar',unlock:{chapter:2},icon:'food',
  ...
  stages:[
   {stage:1,name:'Tonnengrill',cost:{dosenblech:8,kabel:2},effect:{foodHeal:.15},text:'Eine halbe Öltonne. Oskar sagt, das Aroma kommt vom Rost. Verpflegung heilt 15 % mehr.',
    info:{effect:'Jede Verpflegung gibt mehr Leben und mehr Klassenressource – der Anteil liegt auf beiden Werten.',
  ...
  stages:[
   ...
   {stage:2,name:'Werkstatt mit Strom',cost:{kabel:12,dosenblech:10,kronkorken:15},unlock:{chapter:3},effect:{gearChance:.06,coinDrop:.1},text:'Elke hat Strom gelegt. Offiziell von nirgendwo. Ausrüstung +6 Punkte, Pfandmarken +10 Punkte.',
    info:{effect:'Doppelte Ausrüstungs-Chance und zusätzlich Pfandmarken von menschlichen Gegnern.',
     ...
     links:['pfandlager']}},
   {stage:3,name:'Pfand-Ingenieurbüro',cost:{kabel:20,dosenblech:20,'jga-shirt':4},unlock:{chapter:4},effect:{gearChance:.1,coinDrop:.2,energyOnKill:5},text:'Vier Shirts als Putzlappen, eine Drohne mit Greifarm. Ausrüstung +10, Pfandmarken +20, 5 Ressourcenpunkte je Kill.',
    info:{effect:'Höchste Beutechancen, doppelte Pfandmarken und fünf Ressourcenpunkte für jeden erledigten Gegner.',
     why:'Der Nachschub je Kill trägt Gruppenkämpfe: der nächste Gegner beginnt nicht mehr bei null Ressourcen.'}}]},
