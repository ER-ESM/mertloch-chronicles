...
export const TUNING={
 ...
 mechanics:{
  ...
  'schorsch-flamme':{output:{damage:.7},flamme:{bonus:.3,splash:{radius:70,share:.25},overheatFactor:1.2},why:'E-72 Balance-Sheet: Flambierer +60 bis +125 % in Gruppen (Feuerspritzer, Stichflamme ×2, Popcorn) – Flambieren +50 → +30 %, Spritzer 40 → 25 %, Stichflamme ×2 → ×1,4, Faktor 0,85. E-72 R3: splash wieder mit Radius (applyTuning mischt nur eine Ebene – ohne radius trafen die Spritzer nie); Stichflamme ×1,3 → ×1,2 und Faktor 0,78 → 0,74, weil Pfad Stichflamme ab Stufe 10 bei +30 % lag. Runde 2: Ablöschen führt aus „zu heiß“ jetzt in die perfekte Glut statt in die gute – Faktor 0,74 → 0,7',since:'2026-09-25'},
