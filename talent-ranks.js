...
export const RANKS={
 ...
 'dieter-brew-1':chance([25,30,35,40,45],'Jeder Tick von Du schuldest mir Pfand! hat {value} % Chance, 10 Randale zu geben.'),
 ...
 'dieter-brew-20':chance([30,35,40,45,50],'Jeder Tick von Du schuldest mir Pfand! hat {value} % Chance, 6 Leben zu heilen.'),
 'dieter-brew-0':curve('Heilender Rücklauf','%',[5,7,9],'Treffer an Gegnern mit Du schuldest mir Pfand! heilen zusätzlich {value} % des tatsächlich verursachten Schadens.'),
 'baerbel-care-25':chance([50,55,60,65,70],'Kritische Treffer haben {value} % Chance, die Landhaus-Löffelkur 2 Sekunden früher bereitzumachen.'),
 ...
 'baerbel-feedback-1':chance([30,35,40,45,50],'Jeder Tick von Schimmel hat {value} % Chance, 10 Likes und 20 Deckung zu geben.'),
 'baerbel-feedback-13':chance([25,30,35],'Jeder Tick von Schimmel hat {value} % Chance, die Sporenwolke 1 Sekunde früher bereitzumachen.'),
 'baerbel-feedback-0':curve('Heilender Rücklauf','%',[6,9],'Treffer an Gegnern mit Schimmel heilen zusätzlich {value} % des tatsächlich verursachten Schadens.'),
 'baerbel-stage-1':chance([35,40,45,50,55],'Kritische Treffer haben {value} % Chance, die nächste Puderdose ins Gesicht kostenlos zu machen.'),
 ...
 'kevin-fuse-1':chance([25,30,35,40,45],'Jeder Tick der Lunte hat {value} % Chance, eine Flasche in den Kasten zu legen.'),
 ...
 'kevin-hunt-13':chance([50,55,60,65,70],'Glückstreffer haben {value} % Chance, eine Flasche in den Kasten zu legen.'),
 'kevin-hunt-26':seconds([4,6,8],'Der Jackpot hält {value} Sekunden länger.'),
 'kevin-hunt-15':curve('Heilender Rücklauf','%',[8,12],'Treffer auf Ziele mit Kleb die Scheiße fest heilen dich um {value} % des Schadens.')
};
