...
**Entscheidung.**
1. **Eine Lichtkonvention** in `light-convention.js`: Sonne links oben hinter der Kamera, Schatten fallen nach rechts unten (Richtung 0,8 / 0,35), Farbe `#1c2a22`, Deckkraft 0,42. Sie gilt für den Laufzeit-Renderer UND für vorgerenderte Figuren (E-41).
