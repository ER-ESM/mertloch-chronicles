...
3. **Auftragsverfolgung** (0737397, 17e4cea): ohne Kasten und ohne Kopf. Je Auftrag stehen ein Titel und nur der nächste offene Schritt da; die übrigen Schritte, die Belohnung und die Klickwirkung stehen im Tooltip. Die Verfolgung scrollt nicht, was nicht passt, fasst „+N“ zusammen. Sie sitzt unter der Minikarte (`--minimap-bottom`).
...
**Entscheidung.**
1. **Fünf Ressourcenmodelle**, je Klasse eines (`content/resources.js`, Laufzeit `class-resources.js`):
   - **Dosen-Dieter · Randale als Wut + Zeche:** startet bei 0, kommt aus kassierten Treffern, Kelle, Parade; +30 zu Kampfbeginn („Kampfeslust“), der Wurf ist kostenlos und gibt Randale. 30 % jedes Treffers werden angeschrieben und abgestottert; ausgegebene Randale bezahlt die Zeche. Neuer Kniff „Zeche prellen“ (Stufe 6) wirft den Bon als Druckwelle. „In Fahrt“ (E-36) gilt nur noch für Dieter.
   - **Aperol-Anni · Likes + Trend:** Likes ersetzen Randale 1:1 bei den Kosten, fließen aber nur außerhalb des Kampfes nach. Im Kampf bringt jeder Kniff Likes nach Trend; ein Kniff, der nicht unter den letzten zwei war, hebt den Trend (0–5, +4 % Wirkung je Stufe), Wiederholung, Pause und Shitstorm senken ihn; Viral macht den nächsten Kniff gratis.
   - **Klo-Kevin · Leergut:** 12er-Kasten, Würfe kosten Flaschen, heile Flaschen bleiben am Boden liegen und werden durch Drüberlaufen eingesammelt, Kills werfen Flaschen ab. Neuer Kniff „Pfandautomat“ (Stufe 2): Nachladen mit Bon-Zone (voller Kasten + Pfandbon = nächster Flaschenkniff +35 %) oder Klemmer. Leerer Kasten = Pömpel.
   - **Schwenker-Schorsch (neu) · Glut + Grillrost:** Temperatur 0–100 mit Zonen (kalt −15 %, perfekt +20 %, zu heiß +35 % mit Brand, 100 = Stichflamme mit Selbstschaden und Sperre); drei Rostplätze, Grillgut gart nach Glut, gar serviert wirkt am stärksten (Wurst heilt, Braten trifft, Mais platzt, Käse schützt).
   - **Kreuz-Käthe (neu) · Blatt + Augen:** Kartenhand auf den Plätzen 1–3 (Kreuz Schaden, Pik Schild, Herz Heilung, Karo Fläche/Kontrolle), Augen nach Skat (5 + Kartenwert), ab 61 Abrechnen, 90 Schneider, 120 Schwarz; Farbe bedienen verstärkt; Stich gegen Gegnerzauber bricht ihn ab und bringt Augen.
...
**Nachtrag Runden 2–4 (25.09.2026 abends, zwei Kenner-Playtests).** Live bis Build #682.
- **Lernen über das Bild (R3):** Käthes Karten tragen ihre Wirkung als großes Symbol (Klinge, Schild, Herz mit Plus, Knall mit Flächenring), Tempo-Abzeichen für 7–9 / 10–Ass / Bube; Augen-Leiste mit Kerben 61/90/120; Stich- und Kettenrahmen auf den Handkarten; Hofprobe „Karten auf den Tisch“ in drei Bildschritten (`tutorial-guide.js`); Schorschs Servieren leuchtet nach Garstufe. Abrechnen zahlt sichtbar aus (Augen fliegen zum Ziel, Zahl, Stempel, Kartenfächer).
- **Heilung am Grundleben (R3, im Sinne von E-53):** Heil- und Schildmengen der neuen Klassen bemessen sich am Grundleben der Stufe (600 + 45 je Stufe), nicht am Maximalleben; das Balance-Sheet zeigt zusätzlich „eff.“ (ohne Überheilung). `applyTuning` mischt verschachtelte Werte (vorher wirkten Rauch-Radius und Feuerspritzer nie). ⚑ 379 → 220, neue Klassen 13 %, keine Zelle über ±25 %; offen: kevin-fuse Pfad 2 Stufe 5 +30 % (Lunten-Explosion wirkt erst jetzt).
- **Ablöschen** führt aus „zu heiß“ an den Anfang der perfekten Glut (95 → 60), nie unter die gute Glut; wer schon kälter ist, bleibt (Räuchermeister).
- **Kampffluss (R4):** Die Tastenvorwahl (0,4 s) gab es schon; Knopfzahl und Fehlerzeile zeigten aber die eigene Abklingzeit statt der längeren GCD. Kurze Abklingzeiten laufen jetzt mit der GCD ab (`spell-queue.js` `alignCooldowns`). `lowHealth` löst einmal beim Unterschreiten aus (15 s intern) – vorher bei jedem Treffer (4× Deckung). Gleiche Chat-/Kampftext-Zeilen werden zu „×N“; VIRAL ist ein Rahmen statt Beschriftung; ein anderer Kniff schließt den Bodenziel-Modus; Einstellung „Bodenkniffe sofort an der Maus“.
- **Weltgegner (R4, `foe-rules.js`):** Stufenabstand wie am Zielrahmen (ab 3 Stufen darunter −10 % Schaden je Stufe, mind. 25 %); graue Gegner greifen nicht an und holen keinen Kumpel; Kettenzug höchstens 3, Sprünge versetzt; 10 s „Kurzer Schutz“ nach dem Aufwachen; Umland-Gegner tragen ihre echte Stufe (die Beute wächst mit – bewusst); Laufwege meiden bekannte Reviere (`safe-route.js`). Ursache war nicht E-72: Keiler trafen jeden Helden gleich hart, Rudel sprangen im Gleichschlag, „Kumpel kommt“ hatte keine Obergrenze.
- **Einstieg (R3/R4):** F spricht Ida aus jeder Entfernung an; Erinnerungen als Randkarte mit Zeitsteuerung (tritt bei Kampf/Tod/Fenster zurück, schließt nach Lesedauer, weicht der Kampfstatistik aus); Film erst nach dem Ladeschirm, Esc/Enter/Leertaste; Einblendungen nach der Hofprobe nacheinander, Kampfstatistik öffnet sich nicht mehr selbst; Hilfe-Tastenspalten messen ihre Breite.
- **Bilder:** `npm run e72:bilder` (Talentraster → 11 Einzelbilder der getauschten alten Talente → Kniffe; wiederaufnehmbar). Die Talentraster und Kniffe übernimmt der Codex-Lauf der Icon-Sitzung (Sa 26.09., 23:00, `docs/ICONS-CODEX-2026-09-26.md`); danach erzeugt `e72:bilder` nur noch die 11 Einzelbilder.
- **Klassenkleidung Schorsch/Käthe:** Entwurf auf Branch `e72-figuren` (Grillschürze + Mütze, Strickjacke + Lesebrille), nicht auf main, bis der Nutzer freigibt. Befund: Die Hofprobe gab allen Klassen dieselbe Kutte.
- Berichte: `docs/PLAYTEST-2026-09-25-kenner-e72.md`, `docs/PLAYTEST-2026-09-25-kenner-e72-r3.md`, Agentennotizen unter `docs/e72-runde3/` und `docs/e72-runde4/`.

**Nachtrag Runde 5 (26.09.2026, Kenner-Nachtest: Käthe 5/3, Kevin 5/4, Anni 4/4, Schorsch 4/3, Dieter 3/4).** Live bis Build #710.
- **Klicks:** Leere/unsichtbare Plätze der Zusatzleisten fangen keine Klicks mehr (nur beim Bearbeiten/Ziehen/offenem Kniffe-Buch); Rechtsklick auf die Erinnerungskarte läuft (nur Laufen – keine verdeckte Figur dahinter wählen); die unsichtbare Chat-Kopfleiste ist in Ruhe durchlässig; Esc zwischen „Held erstellen“ und Filmbeginn wird früh gemerkt (Inline-Hörer im Seitenkopf); bekannte Erinnerungen erscheinen je Browser nur einmal als Karte; „muss noch verschnaufen“ ist eine leise Zeile, je Kniff höchstens alle 2 s.
- **Welt:** Tode im Kenner-Test entstanden vor allem durch das Browser-Tempo (ein Druck alle 6–8 s) und einen Ruhewart 47 m neben Kisten-Ida. Aggressive Reviere halten zu Ida denselben Abstand wie zur Kirche; Weltgegner kündigen das Bemerken an („!“, Fernkämpfer zücken 1,5 s den Block, wer weggeht, wird nicht angegriffen). Käthe/Schorsch sind am Einstieg nicht zu schwach (mit Kniffen die sichersten Klassen).
- **Klassen:** Schorsch kühlt außerhalb des Kampfes nur bis zur Ruheglut 35 und legt das erste Grillgut bei Kampfbeginn selbst auf; Kevins Bons und Leergut am Boden sind getrennt, der Pfandautomat meldet Treffer/Fehlgriff deutlich; Käthes Farbkette steht ohne Hover im Band; Eckzeichen auf Kniff-Knöpfen (grünes Plus = Heilung, Schild = Schutz); Bodenziel-Hinweis nennt die Schnellzauber-Einstellung.
- Prüfskripte: `scripts/e72-klicks-check.mjs` (bedient = laufen oder Figur wählen, Diagnose je Klick), `e72-welt2-check.mjs`, `e72-klassen5-check.mjs`; `tests/e72-welt2.test.mjs` mit festem Zufallsgenerator.
