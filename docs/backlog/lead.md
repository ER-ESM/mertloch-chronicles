...
- [ ] **Erster Dungeon „Schloss Big B" (Planung 2026-09-23, zweite Fassung):** [DUNGEON-SCHLOSS-BIG-B-2026-09-23.md](../DUNGEON-SCHLOSS-BIG-B-2026-09-23.md). Ziel: die Vorschläge V-D1 bis V-D11 (Abschnitt 20) der Produktion vorlegen, Besitzer für `content/dungeons.js` festlegen, Prüfregeln aus Abschnitt 13 (darunter „jede Reihenfolge der Siegelträger erreichbar") in `content/schema.js`. Abnahme: Einträge in ENTSCHEIDUNGEN.md mit verworfener Alternative. Danach gelten die Verweise in den Inboxen der Rollen. Erster Bauabschnitt (Instanz, drei Ebenen, Trash, Gerd, Karte) liegt zur Ansicht auf dem Zweig `dungeon-schloss-bigb`, Stand im Plan Abschnitt 0; Merge nach `main` erst nach den Entscheidungen.
