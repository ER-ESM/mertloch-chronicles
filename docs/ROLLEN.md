...
| Mobile | `.claude/agents/mobile-agent.md` | `mobile-*.js`, `mobile-translate.js`, `mobile.css`, `scripts/mobile-check.mjs`, `tests/mobile*.test.mjs`, `docs/MOBILE-*.md` | `npm run mobile:check` | `docs/backlog/ui.md` (Abschnitt Mobile) |
