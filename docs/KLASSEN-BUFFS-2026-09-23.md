...
- **Ziel** (seit E-65: das eine gewählte freundliche Ziel, sonst du selbst; der folgende Satz ist Historie). Zuerst ein ausgewählter Söldner oder das Söldner-Hilfsziel. Dann ein ausgewähltes Gruppenmitglied oder das Hilfsziel (E-44). Ohne freundliches Ziel landet der Buff auf dem Zaubernden. Fremde Spieler außerhalb der Gruppe sind kein Ziel. Die Reichweite ist dieselbe wie bei Heilung und Stärkung auf das Hilfsziel (420 Einheiten, `COMPANION_RULES.aidRange` bzw. `SOCIAL_RANGE.aid`).
