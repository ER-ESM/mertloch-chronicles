...
4. **Anni fällt im Stil ab.** Für sie fehlt ein Posenbogen; ihre Karte wird weiter aus `clan-art.js` gezeichnet. Bedarf steht in `docs/UEBERGABE-UI-AN-GRAFIK-2026-09-17.md`.
