...
test('every specialization has a transparent emblem and two distinct resource states within its atlas',()=>{
 ...
 for(const spec of Object.keys(SPEC_MECHANICS).filter(s=>['dieter','baerbel','kevin'].includes(s.split('-')[0]))){/* E-72: Embleme der neuen Klassen folgen mit der Grafiklieferung */
