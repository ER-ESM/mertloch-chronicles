...
test('Kniffe haben Vorrang: neu gelernte Kniffe schieben den letzten Gegenstand auf Leiste 2',()=>{
 ...
 /* E-72: mit „Zeche prellen“ lernt Dieter zehn Kniffe – die Gegenstände weichen auf Leiste 2, keiner geht verloren */
...
test('game.activeBuffs zeigt laufende Stärkungen mit Restzeit und Zugriff auf describe',()=>{
 const g=new Game(arena());g.gainXp(40000);g.player.energy=100;/* E-72 */
