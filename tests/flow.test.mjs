...
const game=(save={level:6},classId='dieter')=>{const g=new Game(arena(),{...save,classId});g.random=()=>.5;g.player.x=g.player.y=0;g.player.hp=g.player.maxHp;g.player.energy=100;/* E-72: Dieter startet sonst bei 0 Randale */return g;};
