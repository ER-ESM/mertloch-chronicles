// Erweiterungsmodul der Anziehpuppe (familien): liefert weitere Quellen im Format von GEAR/GEAR_BACK (puppe.mjs).
...
export function familien(K){return {gear:{},back:{},families:{},sided:[]};}
