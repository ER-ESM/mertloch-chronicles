// Kontaktbögen für Waffen an der Anziehpuppe – direkt aus dem Werkzeug gezeichnet (kein Laufzeitbau nötig), zusammengesetzt mit
...
/** Bilder, in denen das Spiel die Waffe zeigt (Nahkampf nie in Zielen/Schuss, Fernkampf nie im Hieb). */
