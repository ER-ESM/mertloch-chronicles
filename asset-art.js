...
export function drawAssetFire(c,x,y,time){if(!images.fire)return false;const frame=Math.floor(time*10)%7;c.drawImage(images.fire,frame*128,0,128,128,Math.round(x-24),Math.round(y-42),48,48);return true;}
