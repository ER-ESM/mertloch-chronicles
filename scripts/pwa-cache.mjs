...
for(const folder of ['class-visuals','content-art/e32','content-art/locomotion'])for(const file of await readdir(new URL('assets/'+folder+'/runtime/',root)))if(/\.(png|json)$/.test(file))files.push('assets/'+folder+'/runtime/'+file);
