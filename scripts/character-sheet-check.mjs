...
const proc=spawn(chrome,['--headless=new','--remote-debugging-port='+port,'--user-data-dir='+mkdtempSync(join(tmpdir(),'mertloch-sheet-')),'--no-first-run','--hide-scrollbars','about:blank'],{stdio:'ignore'});
let b;const report=[];
try{
