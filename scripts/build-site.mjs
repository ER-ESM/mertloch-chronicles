...
await cp(path.join(root,'assets'),path.join(output,'assets'),{recursive:true,filter:src=>{
 ...
 return !/^(redesign|theme-demo|skill-fx|class-visuals|content-art\/e32|content-art\/locomotion)\/(sources|review)(\/|$)/.test(relative)&&!/^(redesign|skill-fx|class-visuals|content-art\/e32)\/generation\.json$/.test(relative);
}});
