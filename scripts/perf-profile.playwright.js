...
async (page) => {
 const NATIVE=['restore','drawImage','fill','fillRect','stroke','clip','save'],TOP=12,URL='http://localhost:4395/'+(globalThis.__perfQuery||''),COUNT=6,SECONDS=5;
