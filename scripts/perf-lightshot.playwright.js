...
async (page) => {
 const PORT=4395,NAME='nachher',DARKS=[.1,.4];
 ...
 await page.goto('http://localhost:'+PORT+'/');await page.waitForFunction(()=>!!globalThis.__mertloch,null,{timeout:30000});await page.waitForTimeout(1500);
