...
function board(c,x,y,text){if(drawMaifeld(c,'board',x,y+3,WORLD_SCALE.board))return;framed(c,'#8a665a',x-2,y-7,3,15,P.ink,.5);framed(c,'#554655',x-22,y-28,44,22,'#d0ad77',1);c.font="800 5px Nunito,sans-serif";c.textAlign='center';c.fillStyle='#f2d7a1';c.fillText(text,x,y-19);for(const xx of [-14,-3,8]){r(c,'#e8d6ad',x+xx,y-15,8,7);r(c,'#ac8b91',x+xx+2,y-13,4,.5);r(c,'#a08e87',x+xx+2,y-11,3,.5);}}
